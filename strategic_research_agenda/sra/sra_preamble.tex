...
\LTInfoBox{
  ...
  \rowcolor{orange2}{\textbf{Information access and management.} Ex.: Information retrieval.\newline
    \textbf{Communication between humans and between humans and machines.} Ex.: Spoken dialogue system.\newline
    \textbf{Translation of spoken and written content.} Ex.: Document translation.}
  \vspace*{3mm} \\
