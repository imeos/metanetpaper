...
\LTInfoBox{
  ...
  disciplines. References: \cite{carstensen-etal1,jurafsky-martin01,manning-schuetze1,lt-world1,lt-survey1}
  \vspace*{3mm} \\
  ...
  \rowcolor{yellow} Document summarisation & Spoken dialogue system & Document translation\\[2mm]
  \end{tabular}
  \vspace*{2mm} \\
