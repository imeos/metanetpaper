...
\LTInfoBox{
  ...
  \rowcolor{orange2}\vspace{.15cm}\centerline{{\textcolor{white}{\Large What are the major topics?}}}\\[-3mm]

  \rowcolor{orange2}\textbf{Information access and management.} Ex.: Information retrieval.\\

  \rowcolor{orange2}\textbf{Communication between humans and between humans and machines.} Ex.: Spoken dialogue system.\\
  
  \rowcolor{orange2}\textbf{Translation of spoken and written content.} Ex.: Document translation.
  \vspace*{3mm} \\
