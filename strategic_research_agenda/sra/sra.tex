...
\rowcolor{orange2}\vspace{.10cm}\centerline{{\textcolor{white}{\Large  What is Language Technology?}}}\\
\rowcolor{orange2} Language technologies are specialised information technologies for processing automatically the most complex information medium in our world: \emph{human languages} -- in spoken and written form, both in terms of analysis and also generation. Language Technologies are developed by experts involved in computer science, linguistics, computational linguistics and related disciplines. 
\vspace*{3mm} \\ 

\rowcolor{orange1} \vspace{.15cm}\centerline{{\textcolor{white}{\Large  What are common Language Technology applications?}}}\\

\rowcolor{orange1} Spell and grammar checking in text processing applications and editing tools; 
web search; voice dialing; interactive dialogue systems (from banking over the phone to train reservation systems to Apple's Siri); cross-lingual search in digital libraries; natural-sounding synthethic voices for navigation systems; recommender systems for online shops; machine translation systems such as Google Translate, etc.
\vspace*{3mm} \\ 
...
\rowcolor{yellow} \vspace{.001cm} {\Large Information} & \vspace{.001cm} {\Large Communication} & \vspace{.001cm}  {\Large Translation} \\
\rowcolor{yellow} \small access and management & \small human-human; human-machine & \small spoken and written \\[.4em]
\rowcolor{yellow} Example: & Example: & Example: \\
\rowcolor{yellow} Document summarisation & Voice search on mobile devices & Document translation\\[2mm]
\end{tabular}
\vspace*{2mm} \\
...
%\caption{Language technology at a glance}
%\refstepcounter{refs_en}
%\label{fig:lt-overview}
%\end{figure*}
