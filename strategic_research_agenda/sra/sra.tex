...
% Comment out => print version
% Comment in  => ebook version
%\toggletrue{lowres}

% Comment out => ebook version
% Comment in  => print version
\hypersetup{colorlinks=false}

% FIXME: Make all link colours black
...
\ssection*[European Insights and Opinions]{European Insights and Opinions}
...
% \medskip ``The SRA will provide great support for many interesting and necessary research and development projects in the near future!'' --- Jussi Karlgren (CEO, Gavagai)
...
\begin{itemize}
%\item Today’s search technology, online content translation, text analytics and mobile personal assistants are but a first glimpse of the future potential of language technology.
...
\ssection[Towards a Shared European Programme for Multilingual Europe 2020: Next Steps]{Towards a Shared European Programme for Multilingual Europe 2020: Next Steps}
