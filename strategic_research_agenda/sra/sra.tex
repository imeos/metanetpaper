...
% FIXME: Important comments from Serge Gladkoff that can probably best be integrated here. There are also some mentions of legal aspects in the last part of the LR/LT section. Maybe harmonise them?
%
...
% 1)	It is reasonable to believe that not all of technologies will developed from scratch; existing technologies will be used (algorithms, software code, software packages and systems, architecture of computational networks and databases, as well as protocols and data formats). It is therefore inevitable that copyright issues and licensing issues will arise. 
...
% - Die genauen Instrumente werden in den drei bis fünf detaillierten Roadmaps spezifiziert.
% - Die in diesem Dokument aufgeführten Roadmaps sind nur indikativ und stellen den aktuellen Stand der Diskussion dar. Sie werden durch andere EC/EU-geförderte Projekte fortgeschrieben.
% - Hier kommen nur Vorschläge, wie man fortfahren kann.
% - Wie wir dann speziell fortfahren, muss in der nächsten Zukunft konkreter besprochen werden.
