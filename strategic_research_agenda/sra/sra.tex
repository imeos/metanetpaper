...
% FIXME: 
% - Is the story ok? 
% - Are the subsections ok?
% - Any important points missing?

% FIXME:
%
% Alice Dijkstra: 
% - Personally I think there are way too many key messages (LESS is MORE)
% - I would recommend not having more than 10 key messages.
...
\begin{multicols}{2}
  ...
  \item Language barriers are a serious problem and must be torn down for economic, political, societal reasons.
...
%\columnbreak
  ...
  \item We suggest three priority research themes: \emph{Translation Cloud}; \emph{Social Intelligence and e-Participation}; \emph{Socially Aware Interactive Assistants}.
...
\begin{enumerate}
\item \textbf{Translation Cloud}: generic and specialised federated cloud services for reliable spoken and written translation among all European and major non-European languages.
...
\begin{figure*}[htb]
  ...
  \caption{Priority Research Theme 1: Translation Cloud}
