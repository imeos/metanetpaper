...
The successful realisation and implementation of the plans foreseen in this SRA will require setting up a shared programme between the European Commission and the Member States as well as associated countries. The very first steps towards this goal have been taken at META-NET's META-FORUM 2012 conference in Brussels, Belgium, on June 21, 2012, when representatives of several European funding agencies who participated in a panel discussion on this topic, expressed unanimously the urgent need for such a shared programme.

While our concrete suggestions have to be discussed in detail in the months to come, it is apparent that the main research to be carried out under the umbrella of the three priority research themes will be carried out in the EC's Horizon 2020 programme. The European service platform for language technologies is to be supported through the Connecting Europe Facility programme (CEF) while large parts of the core technologies for language analysis and production --~usually very much language-specific data sets and technologies~-- need to be supported through national and regional programmes.

It is still unclear through which collaborative research instrument this shared programme will be implemented. One possible candidate is to set up an Article 185 Initiative \cite{A185}. To quote this very Article of the Treaty of the Functioning of the European Union (TFEU): ``In implementing the multiannual framework programme, the Union may make provision, in agreement with the Member States concerned, for participation in research and development programmes undertaken by several Member States, including participation in the structures created for the execution of those programmes.''

Currently there are four Article 185 Initiatives running: a joint programme on Ambient Assisted Living (AAL), a joint programme in the field of Baltic Sea research (BONUS), a joint programme in the field of metrology (EMRP) and a joint programme for research performing SMEs and their partners (Eurostars). 

One of the key ideas behind an Article 185 Initiative is to coordinate national programmes in order to reduce the fragmentation of research efforts carried out on the national or regional level in Europe. Research and innovation activities as well as policies are meant to converge on the national and European levels. Among the goals to be achieved are to reach critical mass in certain research areas, to ensure better use of scarce resources, to find common answers to common needs and interests, to address global issues at the EU level and to develop common approaches. Member states involved in an Article 185 Initiative are given the opportunity to exchange good practice, to avoid unnecessary overlaps of efforts, to exchange information and expertise and to learn from each other.

There are several criteria for the identification of a potential Article 185 Initiative. The Seventh Framework Programme states that in well-defined cases, an Article 185 Initiative could be launched in areas to be identified in close association with the Member States, including the possible cooperation with intergovernmental programmes, on the basis of a series of criteria: relevance to EU objectives; the clear definition of the objective to be pursued and its relevance to the objectives of the Framework Programme; presence of a pre-existing basis (existing or envisaged research programmes); European added value; critical mass, with regard to the size and the number of programmes involved and the similarity of activities they cover; efficiency of Article 185 as the most appropriate means for achieving the objectives.

Each Article 185 Initiative is set up individually through a decision of the European Parliament and of the European Council, via the co-decision procedure, following a proposal from the European Commission. 
...
Language Technology and the Strategic Research Agenda as specified in this document are a perfectly fitting match for Article 185: multilingualism is an important topic and a high societal challenge within the European Union. By definition, language technology needs major investments as there are substantial amounts of research efforts needed to prepare and create technologies for every language; in other words: it is not possible simply to transpose or to transform technologies to get broad coverage across all languages. Industrial coverage by SMEs plays a very important role. The member states, associated countries and also regions are very much interested to support their language or languages. The European Union is very much interested to enable their citizens and businesses to communicate with one another. The bodies of the European Union (EC, EP, ECJ, EPO, ENISA etc.) are very much interested in supporting their own technological needs with regard to communication and multilingual technologies. 
