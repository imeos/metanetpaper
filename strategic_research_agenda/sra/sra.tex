...
\bigskip ``Given the right attention, the diversity of the European languages can enrich the cultural and commercial development in Europe.  However, if not properly addressed the linguistic diversity can be a serious threat to Europe’s global economic growth.  The META-NET-reports make way for essential discussions and initiatives, may they be read by many!'' --- Bo Vincents (CEO, Ankiro)

\bigskip ``A focus on language technology is one of the most important tools for preserving the linguistic diversity that is one of the core values of the EU. This is why the META-NET project is so important. After all, multilingualism in Europe contributes to exactly what the EU wishes to stand for: Democracy, equality and transparency. The increased focus on the development of language technology underpins these core values in a digital age. Communication between businesses, between organisations, and within the public sector across borders is highly dependent on language technology. There is also an indisputable democratic aspect to language technology in that it offers all inhabitants in the EU the opportunity to contribute economically, politically and socially to the European project, which affects all of our lives. Language technology, and with it the META-NET project, will be essential to breaking down the linguistic and cultural barriers which are otherwise bound to develop.'' --- Sanne Hoffensetz Andresen (Ordbogen)
...
\bigskip ``I think the big issues are handled well already. This is a good agenda!'' --- Niko Papula (Managing Director, Multilizer)
...
\bigskip ``The SRA is a very important document!'' --- Max Silberztein (Université de Franche-Comté)

\bigskip ``I am very happy to have been able to read the [\dots] SRA.'' --- Antonio Balvet (Université Lille~3)
...
\bigskip ``Thanks to all of you for putting together such an impressive document!'' --- Miriam Butt (University of Konstanz)

\bigskip ``The [SRA] represents myself and also my area of research very well. I would like to thank you for all the hard work and effort you put into this!'' --- David Schlangen (University of Bielefeld)

\bigskip ``Thank you for the excellent SRA.'' --- Günther Roscher (ICS Dr.~G.~Roscher GmbH)

\bigskip ``META-NET have laid out a highly compelling vision of how Europe can bridge the digital and the analog, the computer and the human, thus strengthening the communication between us humans -- while preserving our cultural diversity. And not only do they have the vision; their SRA shows that clearly do they have the means, too. For us as a company building social media research tools for the knowledge workers of tomorrow, their research themes are bound to feed right into the success of our core products.'' --- Matthias Bärwolff (Tazaldoo)

\bigskip ``The SRA is a really good piece of work.'' --- Caterina Berbenni-Rehm (FUTUREtec)

\bigskip ``Global communications are a significant success factor for a globally active company. Accordingly, their importance is steadily increasing with the increased globalization and growing complexity of international business. In this context, the design of effective and efficient language management processes makes an important contribution. The development of language technologies already plays a decisive role today and will continue to do so in the future. In this environment, META-NET makes a pivotal contribution in the area of reseach and maintenance of networks with developers and users of language technologies.'' ---
...
\bigskip ``I am happy that such a paper and a common effort for research is planned in such a way and I [am] excited about this common effort.'' --- Attila Törcsvári (Arcanum Development)
...
\bigskip \textbf{Israel:} ``Congratulations on the [\dots] SRA. This is an impressive document.'' --- Ilan Kernerman (CEO, K Dictionaries)
...
\bigskip \textbf{Luxembourg:} ``This is a European challenge of enormous importance!'' --- Roman Jansen-Winkeln (CTO, Belingoo Media Group)
...
\bigskip ``[The SRA is] very stimulating, exhaustive and effective.'' --- Ray Fabri (University of Malta, National Council for the Maltese Language)

\bigskip \textbf{Netherlands:} ``The Strategic Research Agenda provides an interesting and stimulating outlook for the years ahead in a quickly evolving landscape.'' --- Marc Kemps-Snijders (Meertens Instituut)

\bigskip ``I like the vision described very much and the research priorities formulated.'' --- Alice Dijkstra (Nederlandse Organisatie voor Wetenschappelijk Onderzoek)
...
\bigskip \textbf{Romania:} ``We write messages on the mobile phone and we are not even aware of the technology that predicts the words we intend to write. We are accustomed to live in a world where the GPS device points us the way home, telling us when to go left or right. Many technologies developed in the recent years have very concrete implications in the daily life of EU citizens. Linguistic technologies represent a central element of the European Union, because languages themselves occupy a central place in the functioning of the EU.'' --- Leonard Orban (former European Commissioner for Multilingualism)
...
\bigskip \textbf{Spain:} ``I like the spirit of the agenda!'' --- Juanjo Bermudez (Founder, Lingua e-Solutions SL)
...
\bigskip ``Development of language technology is a third reason why not everyone has access to television. A joint Nordic challenge in this area is the development of language technology for texting and reading subtitles. The Nordic countries are small language areas, and therefore the market is not driving the development of language technology by itself. However, the need for reading subtitles is large, because we in the Nordic countries have a tradition of subtitling foreign broadcasts instead of dubbing them, as in many other countries.'' --- Rickard Domeij (head of the Swedish Language Council)

\bigskip ``Thank you for authoring this text! It is very readable and will provide great support for many interesting and necessary research and development projects in the near future!'' --- Jussi Karlgren (CEO, Gavagai)

\bigskip ``The Priority Research Themes hit the bull's eye. Let's all hope for the best for the report.'' --- Jens Erik Rasmussen (New Business Manager, Mikro Værkstedet)

\bigskip ``Thank you for the work that went into compiling the SRA. It is impressive and
clearly shows coverage of the LT area hot topics.'' --- Olga Caprotti (University of Gothenburg)

\bigskip \textbf{Turkey:} ``We would like to thank you for sharing this excellent agenda with us.'' --- Erhan Mengusoglu (Mantis Software)

\bigskip \textbf{UK:} ``Language is a fundamental part of society. Research into Language Technology has already led to the development of software that many people are familiar with, when searching the web, checking spelling in a word processor or booking cinema tickets over the telephone. The work of META-NET is an important step towards a future in which Language Technology will be all around us, allowing us to collaborate, conduct business and share knowledge with friends and colleagues, whether or not we speak the same language.'' --- David Willets (Minister of State for Universities and Science, Department for Business, Innovation and Skills)

\bigskip \textbf{European Commission:} ``Having worked on automatic media analysis for many years and in tens of languages, we are painfully aware of the lack of text analysis tools and resources in most languages. META-NET's analysis is very accurate. Language Technology is a key enabling ingredient for future generations of information technology. Languages for which no tools and resources will exist soon will not participate in the next major technological developments.'' --- Ralf Steinberger (Joint Research Centre, 
...
%
% FIXME: Comment from Christian Dugast -- "Repetitions that are too obvious and word for word exactly the same over a few paragraphs should be avoided. Example section 2-4 and 4-3 are exactly the same ... or the part on European efforts to support language technologies that starts with EUROTRAN appears 2 times ..."
%
% FIXME: Olga Caprotti: "In general I found it hard to read due to a lot of repetition. I believe you can shorten the document and spare the time of your readers by avoiding duplicating entire paragraphs (eg pag 24). Also, there are remarks that holds in general repeated in each theme, e.g. in Organization of Research - that could be moved to #6.5, market opportunities is repetitive too."
...
% FIXME: We need the key points of this document in a bullet point list on a single page.
%
% - The European Union has 23 official languages, geographical Europe has more than XY languages, including immigrants' languages we have XYZ languages.
% - Europe has been very successful in tearing down barriers, from political barriers to financial barriers. The last remaining barriers are language barriers.
% - They have to be tore down as well. Unfortunately, they are very difficult to be torn down. For this, we need technology.
% - For example, today language has certainly become a core business process, and a critical enabler for a wide range of economic, political, and humanitarian activities, and is a valuable subject to all the attendant macroeconomic forces. Since there is a dramatic increase in enterprise information that needs to be localized and translated, we also observe a shrinking number of available (human) translators, a stagnation of the translator's productivity, as well as a decreasing quality of multi-lingual information which today is mostly addressed to the increasing employment of machine translation and other translation automation utilities. These are effective working points to vividly demonstrate how the difference between reacting to changes and to permanently change behaviors contributes to efficiently accomplish the needs and demands of preserving diversity, collaboration, (re-)cycling, and dynamic balance of a networked multilingual ecosystem powered by cloud-enabled energy. (Quote from Jörg Schütz)
% - Language technology is a field between linguistics and computer science that exists since the late 50ies.
% - META-NET is a network of excellence that consists of 60 research centres in 34 countries. Our technology alliance META has more than 650 members.
% - We cooperate with many European projects, research centres, universties, bigger and smaller companies, language communities (EFNIL etc.), industry associations (GALA etc.) etc.
% - If we as the European community now make a dedicated statement and go for a major push in this field, we can get rid of the language barriers until 2020.
% - There are a few good technologies for English but many European languages are seriously under-supported.
% - This will require a modest investment that will pay off immensely with all the benefits it will bring about:
% - Europeans will be able to communicate with one another through technology (both spoken and written).
% - Technologies will enable Europeans to discuss important matters on the European level (vs. in their respective language communities).
% - Software localisation and online technologies will be far superior with built-in language technology from Europe for Europe.
% - European research has a long-standing tradition in this field. 
% - The chance of Europe in making the move from Big Data to Big Semantics is that while giving a meaning to data, we do need language specific knowledge. Developing such technologies (like named entity extraction just to take one) in a multi-lingual environment in need of multi-lingual solutions like Europe is a huge chance for us Europeans to scale these technologies on the multi-lingual dimension and export these technologies to for example the Asian Market which is also very fragmented in terms of languages and that will also need to analyse their Big Data. There is here a very strong multi-lingual engineering knowhow to develop in Europe. If we do it, we are in a much better situation as North America to address Big Semantics for other languages. (remark from Christian Dugast)
% - We suggest three research priority areas: 1) ... 2) ... 3) ...
% - Briefly mention the three ideas for the three videos as potential use cases for the priority themes. (Important comment from Christian Dugast: "The SRA document is too much targeted towards communication solutions, thus promoting a lot the need for automatic translation and not enough towards data analysis and linguistic solutions which is the base of a new coming and very important market.")
% - We suggest to set up a shared programme between the European Union and the member states and associated countries to do the required research and, then, to bring the technologies to the market. This will be a major quantum leap for the development of the European Union, Europe and the whole planet.
% - Mention a few buzzwords: Language Technology for mobile devices ("mobile first"), cloud computing, social networks, big data, open data (big semantics, open semantics?), open standards, protocols, markup languages, ontologies, semantic web -- it's all about a language and it's all about technology.
% - Mention the relation of three priority themes to important buzzwords: translation, big data, open data, social networks, interactive assistants, mobile devices, speech technology etc.
% - Suggestion by Jörg Schütz: "Embed these examples in a tangible grand vision, and develop then the social, strategic, political, and technical actions and procedures that are required, and essentially support the further continuous evolution of a fully fledged sustainable multilingual (service) ecosystem."
% - Suggestion by Jörg Schütz: "As the introductory parts of the document do not reflect at all the need for Big Semantics, it puts the LT dimension on organising, analysing, extracting and giving a meaning to information into a very dull light."
...
%
% Das Ziel mit dieser Publikation die Entscheidungsträger zu informieren kann aus meiner Sicht gelingen. Dazu muss das Executive Summary noch stärker die Gründe für diese drei Forschungsschwerpunkte und den zu erwartenden Nutzen (gesellschaftlich und wirtschaftlich) darlegen.
%
...
%
% "The Executive Summary is not well yet. Needs to be refined – too many unnecessary details, while certain % thoughts, dilemmas etc. should be more clearly written and exposed. Should be better arranged. 
%
...
% FIXME: Comments from Anton Bregar:
%
% % Not well yet. But it is very important to be well because Introduction can attract or discourage polititians and policy-makers. 
% Beginning rather well, interesting. 
%
% In some further paragraphs far too much of „filosophy”, repeating unnecessary and abundant words and phrases and sentences. LT is important, but singing praises to LT is not needed. Some otherwise interesting information doesn't go there. On the other hand, some important details and precisions are missing.
% - E.g. need for LT for machine translation is not questioned, problem is in details: how good these machines have proved to be so far for various purposes, and what are potentials for further development for various purposes (meaning e.g. - for understanding vs. writing texts etc.); good evaluation of efficiency of LT applications is very important issue. 
% - Contents of important documents such as Digital Agenda need to be widely presented in full, but not only fragmentary and instrumentaly, and in unclear way - e.g. page 4, paragraph 6: not clear what the current situation with „many fragmented markets” refers to.    
%
% Introduction can be rather long. It is introduction into the subject issue, problem, current situation; and into main parts of this META document. (See also text under 3- , transferred can be some elements from Executive Summary.)
%
% It should include (or some of this can be transferred to Chapters): 
% what is the issue (language needs of business communities and European citizens, the forms and levels they are served and they are not served, language to language problem; LT – about how it is currently used within language activities – meeting adressed needs, solving language to language problem, what is development here, what was the role of EU language policy so far (including forms of financing) and what have been estimated effects; LT development and application – crucial in future, about existing trends in LT developments in Europe and the world and what are further options in light of basic needs. 
% How the role of language policy factor at the EU level (EU institutions and EU Member's policy makers) has been and is foreseen for the following period (up to 2020) - what so far has been done (good presentation other documents in one place!). About initiation of META, about initial mission of META and what so far has been done, what documents produced etc. (presentation in one place); what is the purpose of this META document; what has been done and what and how this is being used for the purpose of this META document; about contents of Chapters.
%
% Some of the above mentioned elements could be widely presented, as they will not be covered by Chapters.   
%
% Page 4: multilingual Europe: not sufficiently functioning and also costly – a lot of money spent within policy of multilingualism... – (good, interesting); 
% but, there should not be mentioned only dilemma „multilingual Europe or some alternative (predominant position of one language)”; multilingual Europe is the leading EU value and remains to be, but concrete practicle shape of multilingual Europe could accomodate (within this, certain languages already have dominant position and will have further on, but this could be changed, reduced etc.)
%
% Insufficiently functioning single market (very well mentioning) – is an aspect of insufficiently functioning multilingual Europe, which specifically concerns business communities and use of their national languages in cross-border business 
% (in general, approach should be more structured like this - by main sectors, types of subjects and their needs, which are heterogenous in nature – citizens, bussiness units, government institutions).  
%
% Page 4, paragraph 3: instead of „removing” linguistic barriers, should be „overcoming” linguistic barriers 
% (main triade: level of language barriers (unchanged, decreasing, increasing) – overcoming language barriers (important role of LT e.g. for fast and cheap translation of huge ammounts of texts; but foreign language learning falls here too) – avoiding language barriers (e.g. avoiding certain international business opportunities which is harmfull for business).    
%
% Only on page 5, paragraph 1 mentioned META-NET White Papers [14] – ok, if 	previously presented more completely.
%
% Page 5, paragraph 2-3: on EU LT approaches – text of Introduction should be buil up 	around this.
%
% Page 5, paragraph 3: (technology) research activities – language to language aspect – 	important too 
%
% Page 5, paragraph 4: Research activities performed so far (funded by the EU) 	„delivering valuable results 	but often failing to make impact...” - this should be 	extended too  
% For polititians and policy-makers it is important to have idea about the main structure of research activities addressed by this META document and performed so far (not only by language or language pairs) … (and about what in addition to to this is proposed for SRA) 
%
% What is the status of SRA in this document? - mentioned again on page 6, paragraph 4:
%
% Page 5, paragraph 5-6: details about statistical method and approach too extensive for 	Introduction
%
% Page 5, paragraph 7, page 6, paragraph 1: needs to be explained the difference between e.g. India and the EU. This is the way to answer to What is missing in Europe? - Coordination of plans at the Eu level with MC national language policies (- something about this only on page 7, paragraph 4 – this should be integrated into a powerfull paragraph on concept of the language policy factor at the EU level.  
%
% Essential sentence on page 6, paragraph 4: „... To this end, we have developed this Strategic Research Agenda based on...” - Introduction text should be strengthened around this. Polititians and policy makers want to know more about this bases (internal, external). 
% Mentioned „shared (joint) vision” (page 6, paragraph 4; page 7, paragraph 1) should be verified! 
%	
% Page 6, paragraph 5, page 7, paragraph 1-2: about contents of Chapters – should be 	extended, transfer of contents from ES. 
% 	In Introduction it must be explained, what was the approach and proces resulting in 	formulation of „thematic directions” then presented in detail in Chapters. 
%
% Page 7, paragraph 3: organizational aspect of research and innovation – very important; needs to be clearly written about what main change is proposed and argumented and where exactly can be read more.  
%
% Page 7, paragraph 3: statement „... rapid and affectual flow of results into...” crucial as well – text should be extended around this: what is planned to be done about this or what is main idea, where exactly in the text can be read more.

% FIXME: Comment from Christian Dugast: "I would propose to clearly show within the introduction and summary parts the 2 axes along which language technology is needed: for communication (essentially around talking and translating) and for data analysis (organising, understanding, extracting ...). And why not introduce the term of Big Semantics!"

\begin{multicols}{2}
During the last 60 years, Europe has become a distinct political and economic structure. Culturally and linguistically it is rich and diverse. However, from Portuguese to Polish and Italian to Icelandic, everyday communication between Europe's citizens, enterprises and politicians is inevitably confronted with language barriers. Language barriers are an invisible but nevertheless increasingly problematic threat to economic growth as several recent studies have shown \cite{economist12}.

The EU's institutions spend about \emph{one billion Euros} a year on maintaining their policy of multilingualism \cite{EC7}, i.\,e., translating texts and interpreting spoken communication. 

The European market for translation, interpretation, software localisation and website globalisation was estimated at 5.7 billion Euros in 2008. Are these expenses necessary? Are they even sufficient? Despite this high level of expenditure, the actual documents translated represent only a fraction of the information available to the whole population in countries with a single predominant language, such as the USA, China or Japan. 

Language technology and linguistic research as well as related fields such as the digital humanities, social sciences and psychology can significantly contribute to removing linguistic barriers. Combined with intelligent devices and applications, language technology can help Europeans talk and do business together even if they do not speak a common language.
...
Research activities have tended to be isolated, delivering valuable results, often failing to make a decisive impact on the market. In many cases research funded in Europe eventually bore fruit outside Europe. Google and Apple have been noteworthy beneficiaries. In fact, many of the predominant actors in the field today are privately-owned for-profit enterprises based in North America.
...
What is missing in Europe is awareness and political determination and courage that would take us to a leading position in this technology area through a concerted funding effort, a major dedicated push.
...
% FIXME: Dieser Teil hat Einleitungscharakter und fällt sprachlich etwas aus dem Rahmen. Glätten!
...
% FIXME: Peter Spyns on this figure: "What does this figure add ? What is meant by a “connecting language” ? I fail to see the point here."
...
One way to overcome language barriers is to learn foreign languages. Yet without technological support, mastering the 23 official languages of the EU and some 60 other European languages is an insurmountable obstacle for Europe’s citizens, economy, political debate \cite{ombudsman2012}, and scientific progress. The solution is to build key enabling technologies: language technologies (LT) will offer all European stakeholders tremendous advantages, not only within the single market, but also in trade relations with non-European countries, especially emerging economies. Language technologies will eventually serve as the bridge between Europe’s languages.
...
%
% SITUATION AWARENESS as a feature of the application domains outlined in the societal challenges section
%
% Many or even most of the application areas listed in section 2.3 could be improved from a static view of resources to a view congruent with what i have outlined above!  a few words here and there would help: awareness of criminal or violent tendencies in communication patterns for the secure europe challenge, awareness of interest in societal issues and the integration of internet debate and opinion in the e-participation section, reputation mining in  the market awareness section and in the customer care section, attitude analysis in the customer care and e-participation sections, etc etc etc.
...
% FIXME: This is a repeated subsection, of course (see chapter 2).
