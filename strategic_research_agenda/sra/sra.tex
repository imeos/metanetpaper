...
%
% - Section 6 ("LT for ME: The Grand Vision") to be merged with the current introduction (Section 2).
% - Smoothen the text and section structure after the Priority Themes presentation.
% - Cite all important and generic references from the White Paper on German and the section from there.
