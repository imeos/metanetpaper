...
% FIXME: Felix will provide a merged subsection for 3.5 and 3.6
...
% FIXME: Include the Gartner hype cycle here (reproduce the figure) and explain that many (x out of y) of the technologies mentioned in the hype cycle relate to language technologies.
%
% http://www.gartner.com/it/page.jsp?id=2124315
%
% - There are many speech/text/NLP applications contained in the hype cycle.
% - Many technologies are in the "technology trigger" phase.
% - Now is the time to invest in strategic research and to go for a major push.
% - One thing is for sure: these technologies /will/ come. 
% - But: who's going to play their cards right and makes sure that the core competencies stay on their own continent?
...
% FIXME: Briefly mention the "21 European Languages in Danger of Digital Extinction" press campaign and their results! This information is already included in Appendix F but it should be moved here (and updated). The morale of the story: Europe is passionate about the language topic! Europe is also very much concerned about the language topic! People are interested in the topic!
...
% FIXME: Peter Spyns: "No mention is made of knowledge mining for the semantic web (ontology mining, growing and learning), database schemas (research already dating from the ‘80s) and business processes why not link more to the European research themes: e.g., virtual meeting places (with automated minute taking and translation) saves energy, the ozon layer etc.; a lot of HLT can be used for security applications (checking emails) and well-being (telemedicine)."
