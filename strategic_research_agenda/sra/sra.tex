...
\subsection{Powerful Mechanisms for Showcasing and Innovation}
...
Most of European language technology industry is organized in small and medium enterprises. Many of these companies are highly innovative developers and distributors of sophisticated specialized speech and text applications. Because of their creativity, flexibility and specializations in relevant niche markets, they form the most important part of the European LT eco-system. Numerous niches in the LT market are not targeted by the big players, new ones are constantly emerging.  Many specialized needs demand novel technologies that later also permeate into larger markets, some niche markets are early adopter sectors that grow into major market segments.
 
Therefore SMEs do have real opportunities. At the same time, as a key-enabling technology, language technology usually enters the markets in combination with other technologies as an essential component of novel products and services that can be arbitrarily complex and big, which has made it difficult for SMEs to identify customers in the past.But smaller enterprises do not yet have any powerful platforms for incorporating their technologies into other applications. Those with attractive stand-alone applications are able to benefit from global distribution platforms for mobile software such as the app stores for the iOS, Android and Windows Mobile, but the large majority of smaller providers find it increasingly harder to compete with the services provided on the large platforms even if their products are competitive or even unique in their user value.
 
The question is how to transform innovation and research into new markets, products, growth, and, finally, new jobs. Large global platforms for novel end-user-services have become the predominant innovation drivers for language technology solutions. These platforms can be web-services such as Google search that integrates the new Knowledge Graph concept network, speech-enabled search and web-translation. They could also be hardware/OS combinations such as iOS 6 for Apple’s mobile devices with its speech-activated assistant Siri. Or it could be an open operating system such as Android that is expected to extend its current speech and language functionalities in the near future.
 
The situation is quite similar in related sectors of avant-garde industries such as providers of technologies for dealing with knowledge, social interaction and emotion. The trend towards widely used platforms has drastically facilitated spreading innovative technologies. But at closer inspection, the role of sophisticated language technology in current platforms is still rather limited compared with expected opportunities, scratching only the surface of what will be possible in the near future. Actually, language technology has a good chance of becoming the essential feature for the success of the next generation of services.
 
The existence of powerful affordable Internet-based service platforms that can be utilized for the entire technology innovation chain from research to market penetration would speed up both the evolution of human-centric IT and the technological support of European languages.
