...
% FIXME (comment from Olga Caprotti): We need a very short introduction that explains what this chapter is about.
...
% [old part from Hans, commented out] Some technology experts predict this technology for 2013 or 2015, but these forecasts are too optimistic. This does not mean that there could not be useful new speech translation products for selected languages and purposes between now and 2020.
...
% [old parts from Hans, commented out]
...
% [old part from Hans, commented out]
