...
% - Continue writing, editing, revising the text in Chapters 7 and 8.
...
% - Write a few paragraphs on possible EC funding instruments for pan-European initiatives?
...
% Current State of the Art in Research (Folie von Andrejs beim META-FORUM 2012):
% - Open-source MT Toolkits (e.g., Moses)
%   - Maturing and scaling to reach the requirements of massive production use
%   - No general interoperability with LT tools (e.g., parsers, NE recognisers, etc.) 
%   -Confidence estimation (let alone quality estimation) is an open issue
% - Growing availability of multilingual data
%   - Available for many languages, yet in a few domains only
%   - META-SHARE contribution
% - Experimental prototypes for AV media translation
%   - Typically re-speaking scenarios (involving human translators)
% - Support of online media very limited
% - Promising research results from FP7 and ICT-PSP projects
%   - Fragmentation, sustainability, scalability issues
...
Content analytics & & & \\ \addlinespace
Cross-lingual knowledge management and linked open data & & & \\ \addlinespace
Synchronous and asynchronous interpretation & & & \\ \addlinespace
Translingual collaborative spaces & & & \\ \addlinespace\bottomrule
  \end{tabular}
...
% Die "five proposed research lines", die Marko Grobelnik in seinen Folien hatte:
\begin{enumerate}
\item Social influence and incentives
  \begin{itemize}
  \item Modeling social diversity of views across languages and cultures
  \item Modeling social influence and incentives
  \item Multipolar opinion mining (beyond usual sentiment analysis)
  \end{itemize}
\item Information dynamics
  \begin{itemize}
  \item Tracking dynamics of information diffusion across languages, cultures and media
  \item Prediction of future events and identification of causal relationships from textual and social streams
  \end{itemize}
\item Multimodal data processing
  \begin{itemize}
  \item Joining textual data and social networks, including spatial and temporal dimensions
  \item Joining textual and social data with unstructured sources like sensor data (smart cities), video, images, audio
  \end{itemize}
\item Visualization and user interaction
  \begin{itemize}
  \item Visualization of textual and social dynamics
  \item Adaptive user interfaces
  \end{itemize}
\item Algorithmic fundamentals
  \begin{itemize}
  \item Algorithms and toolkits for scalable processing of multi-modal Big data
  \item Real-time modeling and reasoning on massive textual and social streams
  \end{itemize}
\end{enumerate}
...
\begin{figure*}[htbp]
  ...
  \begin{tabular}{@{}p{2.5cm}p{4cm}p{4cm}p{4cm}@{}} \toprule\addlinespace
    ...
    Algorithmic fundamentals & Algorithms and toolkits for scalable processing of multi-modal data (Big-Data) & Real-time modelling and reasoning on massive textual and social streams & Algorithms and toolkits being able to deal with planetary scale analytics and reasoning with multimodal data \\ \addlinespace\bottomrule
  \end{tabular}
  \caption{Priority Theme 2 -- Social Intelligence and eParticipation: Preliminary Roadmap}
...
\begin{figure*}[htbp]
  ...
  \end{tabular}
  \caption{Priority Theme 3 -- Socially-Aware Interactive Assistant: Preliminary Roadmap}
...
\begin{figure*}[htbp]
  ...
  \begin{tabular}{@{}p{2.5cm}p{8cm}p{4cm}@{}} \toprule\addlinespace
    ...
    Infrastructure & Maintain and extend facility(-ies) for sharing resource data and tools; promote accurate and reliable documentation of Language Resources through agreed formal metadata models; define and agree on the basic criteria and dimensions for an appropriate governance; cooperation between infrastructure initiatives to avoid the duplication of effort & Create mechanisms for (automatically) accumulating descriptions of as well as actual speech and language resources; multilingual coverage, ease of access, ease of conversion into uniform formats; technical solutions for integrating language processing services to help organic growth of LR infrastructures (SaaS) \\ \addlinespace
    Coverage, quality, adequacy & Increase quantity of resources available to address language technology and application needs; address formal and content quality of resources by promoting evaluation and validation; promote evaluation and validation activities of LRs and the dissemination of their outcomes & Further increase quantity of resources available to address language and application needs; provide high quality resources for all European languages; coordinated effort at the international level would help by providing less advanced countries, languages with examples and best practices \\ \addlinespace
    LR acquisition & Ensure strong public and community support to definition and dissemination of resource production best practices; enforce recycling, reusing and repurposing (also through appropriate metadata); research work towards the full automation of LR data production; invest in Web 2.0/3.0 methods for collaborative creation and extension of high-quality resources, also as a means to achieve better coverage;
implement workflows of speech and language processing services for acquisition of LRs required for the implementation of the priority themes; bridge LR acquisition methods with linked open data and big data;
share the effort for production of LRs between international bodies and individual countries & \\ \addlinespace
    Openness & Educate key players with basic legal know-how; elaborate specific, simple and harmonised licensing solutions for data resources; promote copyright exception for research purposes; develop legal and technical solutions for privacy protection; opt for openness of LRs, especially publicly funded ones;
ensure that publicly funded resources are publicly available either free of charge or at a small distribution cost; clear IPR at the early stages of production; try to ensure that re-use is permitted & \\ \addlinespace
    Interoperability & Invest in standardisation activities, make standards operational and put them in use; create a permanent Standards Observatory or Standards Watch; set up training initiatives to promote and disseminate standards to students and young researchers; encourage/enforce use of best practices or standards in LR production projects; identify new mature areas for standardisation and promote joint efforts between R\&D and industry & \\ \addlinespace\bottomrule
  \end{tabular}
  \caption{Core technologies and resources: Preliminary Roadmap}
...
% FIXME: Integrate these general points from Hans' META-FORUM 2012 slides:

% Large global platforms for novel end-user-services have become the predominant innovation drivers for language technology solutions.
%
% web-services such as Google search that integrates the new Knowledge Graph concept network, speech-enabled search and web-translation. 
%
% hardware/OS combinations such as iOS 6 for Apple’s mobile devices with its speech-activated assistant Siri. 
%
% open operating system such as Android that is expected to extend its current speech and language functionalities in the near future. 
%
% Of a different nature: iOS distribution platforms such as the Apple AppStore
...
\ssection[Towards a Roadmap for Multilingual Europe 2020]{Towards a Roadmap for\newline Multilingual Europe 2020}
...
%
% - Mention Roadmap
% - Mention shared programme between EU/EC, member states and associated countries (e.g., Article 185)
% - Mention innovation as super-important.

% A few points from Hans' META-FORUM 2012 slides:
%
% Apart from new ways of sharing, development, and distribution, a generally innovative climate is needed. 
%
% mechanisms for 1. encouraging and incentivizing creativity, 2. fostering and rewarding courage, 3. accessing and rebuilding capital need 
%
% These should be incorporated into the planned research and innovation actions, new proposals need to be assessed and tested. 
%
% EC Collaborative Research Instruments
%
% Article 185 of the Treaty on the Functioning of the European Union (TFEU): "In implementing the multiannual framework programme, the Union may make provision, in agreement with the Member States concerned, for participation in research and development programmes undertaken by several Member States, including participation in the structures created for the execution of those programmes." 
% Currently four Article 185 Initiatives: "AAL" - a joint research programme on "Ambient Assisted Living" (use of new ICT in order to enhance the quality of the lives of elderly people) (2008; 150M€ EC + 150M€ MS); "BONUS"- a joint research programme in the field of Baltic Sea research (2010; 50M€ EC + 50M€ MS); "EMRP" - a joint research programme in the field of Metrology (the science of measurement) (2009; 200 M€ EC + 200 M€ MS). One is under the "Capacities" specific programme [PDF]: "Eurostars" - a joint research programme for research performing SMEs and their partners (2008; 100 M€ EC + 300 M€ MS)
%
% An Article 185 Initiative seems to be a perfect fit for the needs described in this document:  
%
% http://cordis.europa.eu/fp7/art185/faq_en.html
%
...
%
% First steps have been taken at our META-FORUM 2012 conference in Brussels where representatives of several member states have participated in a panel discussion about the need for such a coordinated programme between the EU/EC and the member states.
%
% Identification process
%
%What are the relevant "criteria" for the identification of potential Article 185 TFEU (ex Article 169 TEC) initiatives? The Seventh Framework Programme states that in well-defined cases, Article 185 TFEU (ex Article 169 TEC) initiatives could be launched in areas to be identified in close association with the Member States, including the possible cooperation with intergovernmental programmes, on the basis of a series of criteria:
...
% -> Each Article 185 TFEU (ex Article 169 TEC) initiative is set up individually through a Decision of the European Parliament and of the European Council, via the co-decision procedure. Article 185 TFEU Initiatives are set up on the basis of a Council Regulation following a proposal from the Commission.
%
% Implementation: Establishment or existence of a legal Dedicated Implementation Structure (DIS); Should exist before decision; takes care of programme management and Calls for Proposals, projects selection and follow-up; Financial management; sole recipient of EU funding
%
% LT is a great match for Article 185: 
% - High societal challenge on multilingualism in EU
% - LT needs major investments (#LT x  # languages)
% - Industrial coverage by SMEs
% - Interest of MS/AS/regions to support their language(s)
% - Interest of EU to allow communication among citizens / businesses
% - Interest of EU bodies for their own needs (EC, EP, ECJ, EPO, ENISA, etc.)
% - Importance that EC ensures coordination (Best Practices, standards, technology evaluation)
%
% Resolution of the European Council on a “European strategy on Multilingualism” (November 2008). Specifically encourages “the development of language technologies, in particular in the field of translation and interpretation, firstly by promoting cooperation between the Commission, the Member States, local authorities, research bodies and industry, and secondly by ensuring convergence between research programs, the identification of areas of application and the deployment of the technologies across all EU languages”.
