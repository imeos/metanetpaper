...
%
%
%            - META-NET Language Whitepaper | Czech content -
% 
% ----------------------------------------------------------------------------
...
% --------------------------------------------------------------------------
\bsection*{ ... --- Preface} %FIXME Please translate into Czech
...
%FIXME Please translazte the caption into czech. Can you make sure, that this table ist at the right place? In the english part, just give a reference within the text like this:
