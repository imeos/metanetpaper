...
\cleardoublepage
%---------------------------------------
\bsection*{Obsah --- Table of Contents} %done by BH
...
Table~\ref{fig:euromatrix_cz} (p.~\pageref{fig:euromatrix_cz}), which was prepared during the Euromatrix+ project, shows the pair-wise performances obtained for 22 of the 23 EU languages 
...
\bsection[\v{C}lenové META-NET -- META-NET Members]{\v{C}lenové META-NET --- META-NET Members} % Please translate this into Czech
%done by BH
