...
\bsection*{ Předmluva --- Preface} % done by BH
...
\cleardoublepage
%---------------------------------------
\bsection*{Obsah --- Contents} %done by BH
\renewcommand\contentsname{}
\tableofcontents

\addtocontents{toc}{\protect\thispagestyle{empty}\protect}
\addtocontents{toc}{{\Large\textsf{\centerline{ČEŠTINA V DIGITÁLNÍM VĚKU}}\par}} %done by BH
...
Bez technologické podpory, je zvládnutí 23 oficiálních jazyků členských států Evropské unie a dalších cca 60 evropských jazyků nepřekonatelná překážka pro občany našeho kontinentu, jeho ekonomiky, jejich politické debaty a vědeckého pokroku.
...
\boxtext{Jsme svědky digitální revoluce srovnatelné s Guthenbergovým vynálezem knihtisku.}
...
\boxtext{Globální ekonomika a informační prostor nás konfrontují s více jazyky, s více mluvčími a s větším objemem informací.}
...
\boxtext{Současné velké množství jazyků je jednou z nejdůležitějších kulturních předností Evropy a je i nepostradatelnou součástí její úspěšné existence.}
...
\boxtext{Evropa potřebuje robustní a dostupné jazykové technologie pro všechny evropské jazyky.}
...
\boxtext{Jazykové technologie pomáhají překonat úskalí jazykové rozmanitosti.}
...
\boxtext{Současné tempo technologického pokroku je příliš pomalé.}
...
\boxtext{Lidé nabývají znalostí jazyka dvěma různými způsoby: učením se příkladů a učením se základním pravidlům jazyka.}
...
%FIXME please add change sentence above according to
%Finally, we present an expert estimate of core LT tools and resources
%for Czech in terms of various dimensions such as availability, maturity,
%or quality. The general situation of LT for the Czech language is
%summarised in figure~\ref{fig:lrlttable_cz}
%(p.~\pageref{fig:lrlttable_cz}) at the end of the chapter. This table
%lists all tools and resources that are boldfaced in the text. LT support
%for Czech is also compared to other languages that are part of this
%series.
...
%FIXMEplease add translated boxtext
%At its basic level, Machine Translation simply substitutes words in one natural language with words in another language.
\boxtext{Základní systém strojového překladu jednoduše nahrazuje slova v jednom jazyce slovy druhého jazyka.}
%%%DONE by BH March 29
...
%FIXME please add translation of (Irish was not compared) to the last sentence.
%%%DONE by BH March 29

=======
Tabulka~\ref{fig:euromatrix_cz} (str.~\pageref{fig:euromatrix_cz}), která byla připravena v projektu Euromatrix+, obsahuje porovnání úspěšnosti po dvojicích 22 oficiálních jazyků Evropské Unie.
%FIXME please add translation of (Irish was not compared) to the last sentence.
>>>>>>> Stashed changes
\begin{figure*}[tb]
  \centering
...
<<<<<<< Updated upstream
    & \multicolumn{22}{>{\columncolor{corange1}}c}{Cílový jazyk --- \textcolor{grey1}{Target language}}\\\addlinespace[{-.009cm}]
    % FIXME = 'Target language' translation
    %%%DONE by BH March 29
=======
    & \multicolumn{22}{>{\columncolor{corange1}}c}{FIXME -- \textcolor{grey1}{Target language}}\\\addlinespace[{-.009cm}]
    % FIXME = 'Target language' translation
>>>>>>> Stashed changes
...
%FIXME new title: Other Application Areas - please translate
%%%DONE by BH March 29
=======
...
%FIXME please add translated boxtext
<<<<<<< Updated upstream
%%%DONE by BH March 29
...
\boxtext{Aplikace jazykových technologií zajišťují značnou funkcionalitu v zákulisí větších softwarových systémů.}
=======
%Language technology applications often provide significant service functionalities behind the scenes of larger software systems.
>>>>>>> Stashed changes
...
%FIXME new title: Educational Programmes - please translate
% FIXED by BH March 29
...
%FIXME new title: National Projects and Initiatives - please translate
% FIXED by BH March 29
=======
...
%FIXME Please look for the entries in that table below within the text around here and make it textbf{}.
% done by BH
...
{ % defines color for each column.
  ...
  \multicolumn{1}{>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{Excelentní}} & 
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{Velmi dobrá}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{Dobrá}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{Dostatečná}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c}{\textbf{Nízká/neexistující}} \\ 
...
{ % defines color for each column.
  ...
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{Velmi dobrá}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{Dobrá}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{Dostačující}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c}{\textbf{Nízká/neexistující}} \\ 
  \multicolumn{1}{>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{podpora}} & 
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{podpora}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{podpora}} &
...
\begin{multicols}{2}
%FIXME insert newly translated Chapter
<<<<<<< Updated upstream
%FIXED by BH Apr 1
...
=======
META-NET je Síť excelence financovaná Evropskou komisí. V současné době se skládá z 54 členů z 33 evropských zemí \cite{rehm2011}. META-NET podporuje Multilingual Europe Technology Alliance (META), rozrůstající se komunitu odborníků na jazykové technologie a jazykově-technologických organizací v Evropě.\\
META-NET spolupracuje s dalšími organizacemi, jako je Common Language Resources a Technology Infrastructure (CLARIN), která pomáhá vybudovat digitální výzkum humanitních věd v Evropě. META-NET podporuje technologické nadace pro vytvoření a udržování skutečně mnohojazyčné evropské informační společnosti:
>>>>>>> Stashed changes
    \begin{itemize}
...
\end{figure*}
 ...
 Language technology is an established area of research with an extensive set of introductory literature. The interested reader is referred to the following references: \cite{carstensen-etal1, jurafsky-martin01, manning-schuetze1, lt-world1, lt-survey1}.
%FIXME inserted above sentences; replaced section with chapter below i guess
<<<<<<< Updated upstream
% FIXED by BH March 29
...
=======
In the rest of this chapter, we first describe the architecture of a typical LT system. After that, we provide an overview of the core application areas, followed by a brief overview of the situation in LT research and education. Finally, we present an expert estimate of core LT tools and resources for Czech in terms of various dimensions such as availability, maturity, or quality. The general situation of LT for the Czech language is summarised in figure~\ref{fig:lrlttable_en} (p.~\pageref{fig:lrlttable_en}) at the end of the chapter. This table lists all tools and resources that are boldfaced in the text. LT support for Czech is also compared to other languages that are part of this series.
>>>>>>> Stashed changes
%FIXME rewrote laste sentence + added 2
\begin{figure*}[b]
  \colorrule{grey3}{\textwidth}{1.5pt}
  \center
...
%Can you make sure, that this table ist at the right place? In the english part, just give a reference within the text like this:

% added by BH

Figure~\ref{fig:euromatrix_cz} (p.~\pageref{fig:euromatrix_cz}), which was prepared during the Euromatrix+ project, shows the pair-wise performances obtained for 22 of the 23 EU languages (Irish was not compared). %FIXME added (Irish was not compared).

\subsection{Other Application Areas}
%FIXME old title: Information management/``LT behind the scenes''
...
%FIXME old title: LT research and education
...
\item[$\centerdot$]Institute of Czech National Corpus\\(\textit{http://ucnk.ff.cuni.cz/english/index.php});\\CoL;\hspace*{1em}PhD.
\item[$\centerdot$]Institute of Theoretical and Computational\\Linguistics\hspace*{1em}(\textit{http://utkl.ff.cuni.cz});\\ CL;\hspace*{1em}PhD.
...
\item[$\centerdot$]Department of Cybernetics\\(\textit{http://cyber.felk.cvut.cz/});\\ robotics, artifitial intelligence;\hspace*{1em}BSc, MSc, PhD.
\item[$\centerdot$]Department of Circuit Theory\\(\textit{http://noel.feld.cvut.cz/speechlab/start.php?page=\\\hspace*{2em}projects\&lang=en\#2});\\ASR;\hspace*{1em}BSc, MSc, PhD.
\item[] $\!\!\!\!\!\!$\textbf{Masaryk University, Brno}
\item[$\centerdot$] Natural Language Processing Centre\\(\textit{http://nlp.fi.muni.cz/en/nlplab});\\ CL, ASR.
\item[$\centerdot$] Department of Czech Language\\(\textit{http://www.muni.cz/phil/211700?lang=en});\\ CL, TL;\hspace*{1em}BSc, MSc, PhD.
...
\item[$\centerdot$] Department of Cybernetics\\ (\textit{http://www.kky.zcu.cz/en});\\ ASR;\hspace*{1em}BSc, MSc, PhD.
\item[] $\!\!\!\!\!\!$\textbf{Technical University of Liberec}
\item[$\centerdot$]Laboratory of Computer Speech Processing\\(\textit{https://www.ite.tul.cz/speechlabe/})\\ ASR.
\end{enumerate}
<<<<<<< Updated upstream
...
%FIXME old title: LT industry and programs & switched with Educational Programmes
...
=======
The above table summarizes the current state of language technology support for the Czech language. The rating for existing tools and resources is based on assessments of leading experts (0 is worst, 6 is best).
>>>>>>> Stashed changes
...
\bsection[Odkazy -- References]{Odkazy --- References} % Please translate this into Czech
%done by BH
...
\bsection[Členové META-NET -- META-NET Members]{Členové META-NET --- META-NET Members} % Please translate this into Czech
%done by BH
...
<<<<<<< Updated upstream
  ...
  \end{minipage} & \begin{minipage}[t]{0.15\columnwidth}%
    \hfill \\ \textcolor{grey1}{UK}
  \end{minipage} & 
  %FIXME right translations?
  % Spojené království Velké Británie a Severního Irska FIXED by BH March 29
...
=======
  Spojené království & \textcolor{grey1}{UK} & 
  %FIXME right translations?
