...
\FundingLNotice{\selectlanguage{maltese} 
  Il-pubblikatur huwa grat lejn l-awturi tal-white paper Ġermaniża għall-permess li jirriproduċi materjal mill-white paper imsemmija.  Grazzi lil Ritianne Stanyer u Roberta Abela għat-translazzjoni ta' dan id-dokument.
...
\boxtext{Speech interaction is the basis for the creation of interfaces that enable users to interact in spoken language instead of using a graphical display, keyboard and mouse. }
...
Effort then shifted from paper dictionaries to extraction of lexical entries from other sources. Two \cite{Dalli:2001, Attard:2006} %FIXME: Reference Attard:2006 missing
