...
%FIXME: Please translate "Herausgeber" to Maltese!
\editors{
...
ċ \lingua{tʃ}, ġ \lingua{dʒ}, għ (il-biċċa l-kbira siekta), ħ \lingua{h}, ż \lingua{z}.
...
%FIXME: Please translate the caption to Maltese
 \begin{figure*}[htb]
...
%FIXME: I think something is missing here: The paragraph starting with "In this section, we will discuss..." plus the item list in the English version. Please double-check with the English version!
...
Iż-żewġ verbi għamel  u agħmel jiġu ppronunzjati \lingua{ɐː.mɛl}.
