...
%Obwohl in Europa die Voraussetzungen auf Seiten der Forschung und der gut vernetzten Forschungsgemeinschaft mit den Initiativen CLARIN und META-NET, einem derzeit in META-NET in der Entstehung befindlichen, langfristigen Forschungsplan und dem langsam, aber stetig wachsenden Stellenwert von Sprachtechnologie in der Europäischen Kommission momentan ideal sind, stehen wir im internationalen Vergleich in gewisser Hinsicht schlechter da als andere mehrsprachige Gesellschaften wie Indien (23 Amtssprachen) und Südafrika (11 Amtssprachen). 
...
%Im Vergleich zu den USA stehen derzeit in Deutschland für sprachtechnologische Projekte jedoch nur wenig öffentliche Mittel zur Verfügung \cite{laz1}; die Förderung angewandter Forschung in diesem Bereich ist stark zurückgegangen, so dass es der Förderung nun an Kontinuität mangelt. 
...
%Deshalb bedarf es eines erheblichen Einsatzes, um das ambitionierte Ziel hochwertiger Sprachtechnologieunterstützung, unter anderem der maschinellen Übersetzung in hoher Qualität, für alle Sprachen zu erreichen.
