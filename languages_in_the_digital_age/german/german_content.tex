...
Along with many smaller scale projects that have now been completed, the above projects have led to the development of wide-ranging competencies in the field of LT as well as the creation of a basic technological infrastructure for German language tools and resources. However, public funding for LT projects in Germany and in Europe has significantly declined and is relatively low when compared to the amount of money the USA spends on language translation and multilingual information access \cite{laz1}.
At a time when Google Search, Google Translate, Autonomy, IBM Watson and Siri provide evidence for the capabilities of language technology and the research results of the coming years will decide on who will be part of the next revolution in IT, the German-speaking countries run the risk of losing their excellent position in this competition.
...
\emph{In this series of white papers, we have made an important contribution by assessing the language technology support for 30 European languages, and by providing a high-level comparison across these languages. By identifying the gaps, needs and deficits, the European language technology community and its related stakeholders are now in a position to design a large scale research and development programme aimed at building a truly multilingual, technology-enabled communication across Europe.}
...
In the case of the German language, we can be cautiously optimistic about the current state of language technology support. There is a viable LT research community in Germany, Austria and Switzerland, which has been supported in the past by large research programmes, many of them in cooperation with industrial players such as Philips and IBM. Daimler brought language technology into the car. \\
...
Since VERBMOBIL, there has been no significant funding effort in Germany. Programmes like THESEUS only marginally touch on language technology. 
A shift towards EU funding has made it particularly challenging for SMEs to raise funding.
