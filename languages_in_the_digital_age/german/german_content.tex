...
\vspace*{-3mm}
\begin{multicols}{2}
Die Sprache ist ein zentraler Bestandteil unserer Gesellschaft und unserer individuellen Identität. Sie ist einem ständigen Wandel unterworfen, der ganz besonders von Entwicklungen der Kulturtechniken und dem Kontakt mit anderen Sprachen bestimmt wird. Noch nie in der Geschichte haben sich Kulturtechniken und der Austausch zwischen den Menschen so radikal verändert wie in unserer Zeit. Wir sind die erste Generation, die Computer ganz selbstverständlich zum Schreiben, zum Lesen, zum Rechnen und zur Informationssuche einsetzt, aber auch zum Musikhören und zum Betrachten von Fotos und Filmen. In der Tasche tragen wir kleine Computer mit uns herum, mit denen wir telefonieren und korrespondieren, uns informieren und amüsieren, und das an jedem beliebigen Ort. Welche Bedeutung hat die Digitalisierung von Informationen, Wissen und Kommunikation für unsere Sprache? Wird sie sich ändern, wird sie irgendwann verschwinden?
...
%In science fiction movies, everyone speaks the same language -- English, German, or Chinese -- depending on where we watch the film. Could it be %German, even though astronauts rarely mouth German words as naturally as they speak English? 
