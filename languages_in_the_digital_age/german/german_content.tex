...
Die heute auf dem Markt erhältlichen Anwendungen und Tools zur automatischen Übersetzung und Verarbeitung gesprochener Sprache werden den angestrebten Zielen nicht gerecht.  Die dominanten Akteure sind in vielen Bereichen privatwirtschaftliche Unternehmen mit Sitz in den Vereinigten Staaten. Bereits Ende der 1970er-Jahre erkannte die EU die tiefgreifende Bedeutung der Sprachtechnologie als Motor der europäischen Einheit und begann, erste Forschungsprojekte zu finanzieren, z.\,B.~EUROTRA. Diese punktuell geförderten Projekte lieferten im Einzelnen zwar wertvolle Ergebnisse, wie etwa das viel verwendete Open-Source-System Moses zur maschinellen Übersetzung, aber es kam nie zu einer breiten und konzertierten europäischen Initiative.
...
%FIX
Viele der heute eingesetzten Sprachtechnologie-Systeme basieren auf ungenauen statistischen Ansätzen, 
%FIX ENDE
bei denen keine tiefgreifenden linguistischen Analysen und Methoden zum Einsatz kommen. 
...
in der Sprachtechnologie eine leistungsfähige Forschnungsszene., die in der Vergangenheit durch große Forschungsprogramme unterstützt wurde. Viele wurden in Kooperation mit der Industrie durchgeführt, z.\,B.~mit Philips und IBM. Für das Hochdeutsche wurde außerdem eine Reihe umfassender Ressourcen und moderner Technologien entwickelt. Der Umfang der Ressourcen und das Angebot an Tools sind jedoch im Vergleich zum Englischen noch sehr begrenzt und reichen in puncto Qualität und Quantität noch lange nicht aus, um eine wirklich mehrsprachige Wissensgesellschaft technologisch zu unterstützen.
