...
%Deshalb können wir den Schluss ziehen, dass dringender Bedarf an einer umfassenden, koordinierten Initiative besteht, um die Unterschiede in der Sprachtechnologieunterstützung für alle %europäischen Sprachen auszugleichen.
...
META-NET is building a strong European language wide 

%long-term goal is to facilitate the development of high-quality language technology for all languages. This requires all stakeholders - in politics, research, business, and society - to unite their %efforts. The resulting technology will help tear down existing barriers and build bridges between Europe’s languages, paving the way for political and economic unity through cultural diversity. 
