...
This whitepaper series complements the other strategic actions taken by META-NET (see the appendix for an overview). Up-to-date information such as the current version of the META-NET vision paper\cite{Meta1} or the Strategic Research Agenda (SRA) can be found on the META-NET web site: http://www.meta-net.eu.
  ...
  % --------------------------------------------------------------------------
  \ssection{Unsere Sprachen in Gefahr: Eine Herausforderung für die Sprachtechnologie --- Our Languages at Risk: a Challenge for Language Technology}
...
Finally, one active field of research is the use of language technology for rescue operations in disaster areas, where performance can be a matter of life and death: Future intelligent robots with cross-lingual language capabilities have the potential to save lives.
  ...
  \ssubsection{Herausforderungen für die Sprachtechnologie --- Challenges Facing Language Technology }
...
>{\columncolor{corange1}} p{.17\linewidth}@{\hspace{.027\linewidth}}
...
>{\columncolor{corange5}}p{.17\linewidth} 
}
