...
\title{The German Language in the Digital Age \protect\linebreak --- \protect\linebreak Die deutsche Sprache im digitalen Zeitalter}

\subtitle{English / Deutsch}

\author{
  Aljoscha Burchardt \and
  Markus Egg \and
  Kathrin Eichler \and
  Brigitte Krenn \and
  Annette Leßmöllmann \and
  Georg Rehm \and
  Manfred Stede \and
  Hans Uszkoreit \and
  Martin Volk 
...
\begin{figure}[h!]
	\center
\includegraphics[width=0.4\textwidth]{../@media/language_technologies}\\
...
\begin{figure}[h!]
\center
\includegraphics[scale=0.6]{../@media/text_processing_app_architecture}\\
...
\begin{figure}[h!]
	\center
		\includegraphics[scale=0.7]{../@media/language_checking}\\
...
\begin{figure}[h!]
\center
\includegraphics[scale=0.6]{../@media/web_search_architecture}\\
...
\begin{figure}[h!]
\center
\includegraphics[scale=0.7]{../@media/simple_speech-based_dialogue_architecture}\\
...
\begin{figure}[h!]
\center
\includegraphics[scale=0.7]{../@media/machine_translation}\\
...
\begin{figure}[h!]
\center
\includegraphics[scale=0.6]{../@media/grit}
 \end{figure}
...
\begin{figure}[h!]
\center
\includegraphics[scale=0.75]{../@media/metanet-paper2}
 \end{figure}
...
\begin{figure}[h!]
\center
\includegraphics[scale=0.4]{../@media/bild}\\
