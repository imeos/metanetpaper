...
\twocolumn[\ssection{Languages at Risk: a Challenge for Language Technology}]
...
\twocolumn[\ssection{The German Language in the European Information Society}]
...
German is very productive when it comes to coining new words due to the compounding system that allows combining words and affixes in a simple way. In theory, this allows for the creation of infinitely long words, where other languages might use a set phrase:
 ...
 \begin{itemize}
      ...
      \item Selbstverteidigungsminister [minister of self-defence]
      \item Bundesselbstverteidigungsminister [federal minister of self-defence] 
    \end{itemize}
...
\begin{itemize}
      \item Er \textbf{stellte} sich, nachdem er mir ein Getränk angeboten hatte und wir ins Gespräch gekommen waren, \textbf{vor}.
      \item {[}He \textit{introduced} himself after he had offered me a drink and we had started a conversation.{]}
\end{itemize}
...
Language skills are a key qualification for education and personal and professional communication. Yet, German plays a relatively minor role as a school subject in secondary education. According to OECD figure*s published in 2003, German language instruction forms about 20\% of the school curriculum for nine to eleven year old pupils, compared with almost 33\% native language instruction in France, Greece and the Netherlands \cite{kmk1}.
...
\twocolumn[\ssection{Language Technology Support for German}]
