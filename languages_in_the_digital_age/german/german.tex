...
Three Lines of Action in META-NET\\
  ...
  \subsection{Mitgliedsorganisationen --- Member Organisations}

  \ParallelLText{
Die folgende Liste enthält die Organisationen und ihre Vertreter, die sich am META-NET beteiligen.
  }
  \ParallelRText{
  ...
  % Die nachfolgende Liste muesste vollstaendig und korrekt sein, sollte aber noch mal ueberprueft werden (auch in Bezug auf die diakritischen Zeichen) -- Georg
