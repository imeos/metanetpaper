...
Austrian German (AT) is a variant of German (\textit{Oberdeutsch}) whose lexicon differs from the official language used in Germany (DE), e.g.:
  ...
  \begin{tabular*}{\textwidth}{c|c|c}
    \hline
    \textbf{Englisch - English} & \textbf{Österr. Deutsch - Austrian German} & \textbf{Hochdeutsch - Standard German}\\
    \hline
    Chair & Sessel & Stuhl\\
    \hline
...
Three Lines of Action in META-NET\\
  ...
  \ParallelLText{
Die folgende Liste enthält die Organisationen und ihre Vertreter, die  derzeit an META-NET beteiligt sind.
  }
  \ParallelRText{
    The following table lists the organisations and their representatives that currently participate in META-NET.
  }
