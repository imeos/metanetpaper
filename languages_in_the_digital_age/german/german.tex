...
\end{figure}
  ...
  \ParallelLText{\selectlanguage{german}
In diesem Abschnitt konzentrieren wir uns auf die wichtigsten sprachtechnologischen Tools und Ressourcen und geben einen Überblick über Aktivitäten zum Bereich Sprachtechnologie in Deutschland, Österreich und in der Schweiz. Im Text fett gedruckte Tools und Ressourcen sind auch in der Tabelle am Ende dieses Kapitels zu finden.
  }
  
  \ParallelRText{\selectlanguage{english}
    In this section, we focus on the most important LT tools and resources, and give an overview of LT activities in Germany, Austria and Switzerland. Tools and resources that are boldfaced in the text can also be found in the table at the end of this chapter.
  } 
