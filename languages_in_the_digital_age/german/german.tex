...
\end{tabular}
\label{tab:lrlttable}
\caption{Status der Sprachtechnologieunterstützung für Deutsch -- \textcolor{grey4}{State of language technology support for German}}
\end{figure}
...
\caption{Sprachcluster für die Verarbeitung gesprochener Sprache -- \textcolor{grey4}{Language clusters for Speech Processing}}
\end{sidewaysfigure}
...
\caption{Sprachcluster für maschinelle Übersetzung -- \textcolor{grey4}{Language clusters for Machine Translation}}
\end{sidewaysfigure}
...
\caption{Sprachcluster für Textanalyse -- \textcolor{grey4}{Language clusters for Text Analysis}}
\end{sidewaysfigure}
...
\begin{tabular}{>{\columncolor{orange2}} p{.17\linewidth}@{\hspace{.027\linewidth}}>{\columncolor{orange2}}p{.17\linewidth}@{\hspace{.027\linewidth}}>{\columncolor{orange2}}p{.17\linewidth}@{\hspace{.027\linewidth}}>{\columncolor{orange2}}p{.17\linewidth}@{\hspace{.027\linewidth}}>{\columncolor{orange2}}p{.17\linewidth} }
  ...
  \caption{Sprachcluster für Ressourcen -- \textcolor{grey4}{Language clusters for Resources}}
\end{sidewaysfigure}
