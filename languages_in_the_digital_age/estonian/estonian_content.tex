...
\hspace{4mm}\textit{The woman saw the car and her husband, too.}

\hspace{4mm}\textit{[Naine nägi autot ja tema abikaasa samuti.]}

\hspace{4mm}\textit{[Naine nägi autot ja samuti oma abikaasat.]}\\
...
Idee kohaselt esitab kasutaja konkreetse küsimuse, millele süsteem annab ühe vastuse. Näiteks:
...
Automaatne sisukokkuvõtete tegemine ja \textbf{teksti genereerimine} on kaks sellist piiripealset ala, mille rakendused toimivad nii iseseisvate programmidena kui ka toetavas rollis n.ö kulisside taga. 
...
\textbf{META-NET} on Euroopa Komisjoni rahastatud tippteadmiste võrgustik, millel on 54 liiget 33-st Euroopa riigist  \cite{rehm2011}. 
...
between Europe’s member states in terms of both the maturity of the research and in the state of readiness with respect to language solutions
%in the state of readiness with respect to language solutions and the state of research between Europe’s member states. 
Even for large European languages like German or English with well studied language technologies there are still many open research issues, thus for Estonian the amount of further research is even more extensive. 
...
\item[]  (He/she will arrive tomorrow.)
\end{itemize}
...
\item[]  (If he/she trained more, he/she would run faster.)
\end{itemize}
...
\item[]  (It has been told that he/she runs fast.)
\end{itemize}
...
\item[]  (He/she ran home fast.)
\item[] \textit{Kiiresti jooksis ta koju.}
\item[]  (It was very fast how he/she ran home.)
\item[] \textit{Koju jooksis ta kiiresti.}
\item[]  (He/she ran home fast [but not so fast to school].)
\item[] \textit{Jooksis ta kiiresti koju?} 
\item[]  (Did he/she run home fast?)
\item[] \textit{Kui ta kiiresti koju jooksis, siis \ldots}
\item[]  (While he/she was running home fast, \ldots)
\end{itemize}
...
There are a lot of specialised Internet forums, where users communicate in Estonian. 
Also the social networks like Orkut and Facebook have been localised to Estonian. 
...
The key results for Estonian %language technology 
