...
\authoraffiliation{
  \mbox{Maite~Melero~ {\small \mbox{Barcelona~Media~Centre~d'Innovació}}}\\
  \mbox{Toni~Badia~ {\small Universitat Pompeu Fabra}}\\
  \mbox{Asunción~Moreno~ {\small \mbox{Universitat~Politècnica~de~Catalunya}}}
}
