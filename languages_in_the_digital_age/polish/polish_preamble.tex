...
\FundingLNotice{\selectlanguage{polish}
  ...
  \bigskip
  Przekład na język polski: Anna Cichosz\vfill
  \bigskip
...
\FundingRNotice{\selectlanguage{english}
  The author of this document is grateful to the authors of the White Paper on German for permission to re-use selected language-independent materials from their document \cite{lwpgerman}.\vfill
  \bigskip
  Polish translation: Anna Cichosz\vfill
  \bigskip
