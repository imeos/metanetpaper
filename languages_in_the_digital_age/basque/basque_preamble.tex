...
%``In the context of a multilingual Europe, Information and Communication Technologies are a strategic area for all languages, and especially for minority %languages. Nowadays, thanks to the Internet —once the geographic and linguistic barriers have been overcome—, the users of these Technologies have %an exceptional opportunity to get ICT products in the language they choose. But, for that it is absolutely necessary that our small languages are inside the %ICT market. META-NET project offers the suitable platform to achieve this goal."
