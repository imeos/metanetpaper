...
\begin{center}\vspace*{-2mm}\textbf{Bikaina}\end{center} & 
\begin{center}\vspace*{-2mm}\textbf{Ona}\end{center} & 
\begin{center}\vspace*{-2mm}\textbf{Ertaina}\end{center} & 
\begin{center}\vspace*{-2mm}\textbf{Osagabea}\end{center} & 
\begin{center}\vspace*{-2mm}\textbf{Apala/Ez}\end{center} \\ \addlinespace
...
Language is the primary means of communication between humans. It allows us to express ideas and feelings, helps us to learn and teach, is essential for living, is the primary vehicle of transmission of culture, and is a symbol of identity for their speakers.

    \boxtext{Language is the primary means of communication between humans}
    
In the current globalized world, we have many ways to easily communicate with people from all over the world. For example, the new information and communications technologies have enabled the development of social networks that have contributed to enhance the interaction between people from different countries and cultures. Also, in recent years, we have seen large movements of foreing people in our countries, i.e. tourism or immigration, that creates the necessity of communication among different languages. This cross-lingual communication problem is often solved thought the use of a lingua franca.

Europe is a clear example of linguistic and cultural diversity despite of during the last 60 years Europe has become a distinct political and economic structure. This means that from Basque to Polish and from Italian to Icelandic, language barriers inevitably confront everyday communication between Europe’s citizens as well as communication in the spheres of business and politics. The European Union’s institutions spend about a billion euros a year on maintaining their policy of multilingualism, i.e., translating texts and interpreting spoken communication. In parallel, English is becoming a lingua franca in the communication between European citizens.

In the area of Spain we also find the same scenario. Spain has an official language, Spanish, also known as Castilian, and three co-official languages: Catalan, Galician and Basque. Preserving multilingualism in Spain has not been an easy task but rather the result of a complex process that has prevailed in the preservation of cultural and linguistic identity on the preponderance of Spanish on the other. Similarly to the use of English in the European case, direct communication between citizens of different language areas of Spain, often need the use of Spanish as a lingua franca.

    \boxtext{Multilingualism is a cultural heritage to be preserved}

At both, the European and the Spanish levels, the multilingualism is a cultural heritage to be preserved. Globalization should not become a mechanism that promotes the abandon of our rich linguistic and cultural heritage as it invites to jeopardize the use of our own language in favor of a lingua franca. Within a global communication world, we should find ways to preserve our own language and, with it, our cultural identity.

Modern language technology and linguistic research can make a significant contribution to pulling down these linguistic borders. When combined with intelligent devices and applications, language technology will in the future be able to help citizens talk easily to each other and do business with each other even if they do not speak a common language. Language technology solutions will eventually serve as a unique bridge between different languages. The language technologies and speech processing tools currently available on the market – ranging from question answering systems to natural language interfaces, and including translation systems and summarization tools, among many others-, still fall short of this ambitious goal. 
...
As this series of white papers shows, there is a dramatic difference among countries in the state of readiness of their language solutions based on language technologies. One of the major conclusions is that Basque is one of the EU languages that still needs further research before truly effective language technology solutions are ready for everyday use. At the same time, there are good prospects for achieving an outstanding position in this important technology area. This development of high-quality language technology for Basque is urgent and of utmost importance for the preservation for a minority language as Basque.
...
\bsection[Aipamenak -- References]{Aipamenak --- References}
...
\bsection[META-NETeko Kideak -- META-NET Members]{META-NETeko Kideak --- META-NET Members}
...
\bsection[META-NETen liburu zurien bilduma -- The META-NET White Paper Series]{META-NETen liburu zurien bilduma --- The META-NET\ \ \ \ \ \ White Paper Series}
