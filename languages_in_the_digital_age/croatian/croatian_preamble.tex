...
\spineTitle{\raisebox{-4mm}[0mm][4mm]{The Croatian Language in the Digital Age --- Hrvatski Jezik u Digitalnom Dobu}}
...
\authoraffiliation{
  ...
  \footnotesize{[2]} ~\hspace*{.3mm}\small{Institut za hrvatski jezik i jezikoslovlje}
}
...
\quotes{%
 ...
 \textcolor{grey2}{--- Prof.~dr.~Milena Žic Fuchs (redoviti član Hrvatske akademije znanosti i umjetnosti, predsjednica Stalnoga odbora za humanističke znanosti Europske znanstvene zaklade)}\\[3mm]
