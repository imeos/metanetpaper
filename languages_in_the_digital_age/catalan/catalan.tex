...
\FundingLNotice{\selectlanguage{catalan} The authors of this document
...
% --------------------------------------------------------------------------
\bsection*{Taula de Continguts --- Table of Contents}
...
\begin{figure*}[htb]
  ...
  \caption{FIXME:Language technology in context, and reference}
...
\begin{figure*}[b]
  ...
  \caption{FIXME: caption and references}
...
\begin{figure*}[htb]
  ...
  \caption{FIXME: caption Sprachüberprüfung (oben: statistisch; unten: regelbasiert)}
...
\begin{figure*}[htb]
  ...
  \center
  \caption{FIXME: Sprachdialogsystem}
...
\begin{figure*}[htb]
  ...
  \vspace{-2mm}
  \caption{FIXME: Maschinelle Übersetzung (links: statistisch; rechts: regelbasiert)}
  \label{fig:mtarch_ca}
  \colorrule{grey3}{\textwidth}{1.5pt}
\end{figure*}
...
\bsection[Literaturverweise -- References]{Referències --- References}
