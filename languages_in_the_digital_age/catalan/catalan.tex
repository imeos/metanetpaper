...
%FIXME: "white paper" and "white paper series" in Catalan?
...
\tableofcontents
%FIXME -"The Catalan Language in the Digital Age" in Catalan
...
%FIXME: the following needs to be translated.
...
\bsection[Organitzacions membres -- META-NET Members]{Organitzacions membres --- META-NET Members}
%FIXME - "META-NET Members" in Catalan
...
%FIXME: "The META-NET White Paper Series" in Catalan
