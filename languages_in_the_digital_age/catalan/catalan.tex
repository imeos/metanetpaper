...
%FIXME: "onze" in "llengües europees" needs to be "twenty-one" below.
...
%FIXME: Translate "Excellent, Good, Moderate, Fragmentary, Weak/no" into Catalan
...
%FIXME: translate above two paragraphs into Catalan, add into the Catalan part.
...
%FIXME: translate above item into Catalan
...
%FIXME: "Set in bold text" needs to be adapted in the Catalan part.
...
%FIXME: "set in bold" needs to be translated in the Catalan part.
...
%FIXME: check that above caption is correct in Catalan
...
%FIXME: translate above paragraph into Catalan, translate Euromatrix caption in the Catalan part.
