...
\begin{figure*}[tb]
  ...
  \begin{tabular}{>{\columncolor{corange1}}cccccccccccccccccccccccc}
    & \multicolumn{22}{>{\columncolor{corange1}}c}{NORWEGIAN -- \textcolor{grey1}{Target language}}\\\addlinespace[{-.009cm}]
    ...
    \end{tabular}
  \caption{NORWEGIAN -- \textcolor{grey1}{Machine translation between 22 EU-languages \cite{euro1}}}
...
%start Norwegian
Prosjektet EuroMatrix+ gjennomførte en studie av kvaliteten på maskinoversettelsessystemer for 22 offisielle EU-språk.
