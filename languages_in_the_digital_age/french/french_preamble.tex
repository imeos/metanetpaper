...
\authoraffiliation{
  Joseph Mariani~ {\small IMMI-CNRS \& LIMSI-CNRS}\\
  Patrick Paroubek~ {\small LIMSI-CNRS}\\
  Gil Francopoulo~ {\small IMMI-CNRS \& TAGMATICA}\\
  Aurélien Max~ {\small LIMSI-CNRS \& U. Paris Sud 11}\\
  François Yvon~ {\small LIMSI-CNRS \& U. Paris Sud 11}\\
  Pierre Zweigenbaum~ {\small LIMSI-CNRS}\\
}
\editors{
...
allemand de leur avoir permis de réutiliser des éléments génériques de
leur document \cite{lwpgerman}.
  ...
  dans le cadre des contrats T4ME (convention d’aide 249119), CESAR
  (convention d’aide 271022), METANET4U (convention d’aide 270893) et
  META-NORD (convention d’aide 270899).}
