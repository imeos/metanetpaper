...
with stakeholders (software companies, technology
...
\subsection{Des opportunités \mbox{pour les Technologies} de la Langue}
Dans le monde de l'imprimerie, l'avancée technologique a été la
possibilité de reproduire rapidement l'image d'un texte en utilisant
une presse d'imprimerie suffisamment puissante. Il revenait aux
humains de faire le dur travail de rassembler, d'évaluer, de traduire
et de résumer la connaissance. Il a fallu attendre Edison pour
enregistrer la voix humaine - et cette fois encore, la technologie
n'était capable que de produire des copies analogiques.
...
traitement de l'information et de gestion des connaissances pour
toutes les langues européennes. Les technologies de la langue peuvent
également favoriser le développement d'interfaces vocales pour les
appareils électroniques domestiques, les machines, les véhicules, les
ordinateurs, les téléphones ou les robots. Les applications
...
éventail d'opportunités. Par exemple, la traduction automatique
atteint déjà une qualité raisonnable dans des domaines spécifiques et
des applications expérimentales permettent d'effectuer la fourniture
d'information multilingue, la gestion des connaissances ainsi que la
production de contenus dans de nombreuses langues européennes.

Comme pour beaucoup de technologies, les premières applications, comme 
celles des interfaces vocales et des systèmes de dialogue, ont d'abord 
été développées dans des domaines spécialisés, et ont souvent présenté 
des performances limitées. Il y a cependant d’énormes opportunités de 
marché dans les industries de l'éducation et du divertissement 
concernant l'intégration des technologies de la langue dans les jeux, ou 
dans les offres de logiciels ludo-éducatifs, les bibliothèques, les 
environnements de simulation ou les programmes de formation.
Les services d'information mobiles, les logiciels d'apprentissage des 
langues assisté par ordinateur, les environnements d'apprentissage en 
ligne, les outils d’auto-évaluation ou les logiciels de détection de 
plagiat ne sont que quelques exemples où les technologies de la langue 
peuvent jouer un rôle important. La popularité des réseaux sociaux comme 
Twitter ou Facebook induit un besoin accru de technologies de la langue 
sophistiquées qui puissent filtrer les messages, résumer les 
discussions, suggérer des tendances d'opinion, détecter des réactions 
émotionnelles, identifier les infractions au copyright ou pister les 
...
pour l'Union européenne. Elles peuvent aider à traiter la délicate
question du multilinguisme en Europe - le fait que plusieurs langues
coexistent naturellement dans les entreprises européennes, les
...
utilisation libre et ouverte de chacune des langues. Si l'on se
projette encore plus loin, les technologies de la langue multilingues
innovantes pour l'Europe peuvent aussi servir d'exemple à nos
partenaires mondiaux lorsqu'ils s'adresseront à leurs propres
communautés multilingues. Les technologies de la langue peuvent être
vues comme des sortes de technologies «~d'assistance~» qui aident à
résoudre le «~handicap~» de la diversité des langues et rendent les
communautés linguistiques plus accessibles les unes aux
autres. Finalement, un champ de recherche actif concerne l'utilisation
des technologies de la langue pour les opérations de sauvetage dans
les zones sinistrées~\cite{resnick2011}. Dans un tel environnement à
haut risque, la précision de la traduction peut être une question de
vie ou de mort~: dans le futur, des robots intelligents ayant des
capacités de communication inter-langues auront la capacité de sauver
des vies humaines.
...
While the printing press helped step up the exchange of information in Europe, it also led to the extinction of many European languages. Regional and minority languages were rarely printed and languages such as Cornish and Dalmatian which were limited to oral forms of transmission were, in turn, restricted in their scope of use compared to printed languages. Will the Internet have the same impact on our modern languages?
\boxtext{The wide variety of languages in Europe is one of its richest and most important cultural assets.
}
Europe's approximately 80 languages are one of our richest and most important cultural assets, and a vital part of this unique social model~\cite{EC2}. While languages such as English and Spanish are likely to survive in the emerging digital marketplace, many European languages could become irrelevant in a networked society. This would weaken Europe's global standing and run counter to the strategic goal of ensuring equal participation for every European citizen regardless of language. According to a UNESCO report on multilingualism, languages are an essential medium to exercise the fundamental rights, such as political expression, education and participation in society~\cite{UNESCO2007}.
...
multilingualism, which specifically encourages {\em ``the development
  ...
  deployment of the technologies across all EU languages''}~\cite{eurlex}. This resolution has not yet produced any effect.
...
lost a lot of its supremacy with the raise of English (or Globish
...
its influence has waned in recent years. In colonial Vietnam, the
...
available in 2011 for 8 language pairs on Apple {\em App Store}. Google offered
...
Internet, and e-mail channels. This tendency will also affect the
...
decrease in the long run. On the other hand, the usage of spoken
...
progress. The BLEU measure was proposed in 2000\cite{bleu02} and allowed for
...
specific classes of documents; this could be, for example, the detection of the
...
on speech, was active in the past, but now seems to be idle.
...
\item {\bf Coverage}~: To which degree do the best tools meet the respective coverage criteria (styles, genres, text sorts, linguistic phenomena, types of input/output, number languages supported by an MT system etc.)? To which degree are resources representative of the targeted language or sublanguages?
      \begin{itemize}
...
\begin{itemize}
      \item 0~: practically impossible to adapt a tool/resource to another task, impossible even with large amounts of resources or available person-months
...
initiatives based on the translation of US FrameNet and even though it
...
semantics. The effort to develop a semantically annotated
corpus is huge.
...
\item Research was successful in designing high quality software,
...
technology (text analysis), along with basic resources needed for
...
the language barrier appears as one of the main factors of limited
...
A large, coordinated effort on language technologies would help save
the French language just like all the other languages, and multilingualism,
