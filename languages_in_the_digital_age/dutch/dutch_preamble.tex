...
\FundingRNotice{\selectlanguage{english}
  ...
  Furthermore, the author would like to thank Catia Cucchiarini (Nederlandse Taalunie), Walter Daelemans (Universiteit Antwerpen), Alice Dijkstra (NWO), Jean-Pierre Martens (Universiteit Gent), Jacomine Nortier (Universiteit Utrecht), Peter Spyns (Nederlandse Taalunie) and Remco van Veenendaal (TST-centrale) for their contributions to this white paper.
  \bigskip   \bigskip 
