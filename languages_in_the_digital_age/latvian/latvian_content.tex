...
\boxtext{The State Language Commission has set the following key goal: Latvian shall be provided with a full software support in all popular technologies and it should be developed in pace with the development of new technologies.}
