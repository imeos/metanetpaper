...
%FIXME: Shortened boxtext above, please validate!
...
Interpunkcijas likumi latviešu valodā ir tik sarežģīti, ka, labi nezinot gramatiku, rakstīt ir gandrīz vai \mbox{neiespējami}.
...
Ir \mbox{vērojama} arī tendence pašlaik notiekošās pārmaiņas valodā vērtēt izteikti negatīvi (gan izsakoties vispārīgi — \textit{valoda degradējas, tiek piesārņota} —, gan konkrēti, norādot uz nevēlamām parādībām). 
...
Vispārējā VT situācija latviešu valodas kontekstā ir apkopota ~\ref{fig:lrlttable_de}.~attēlā.
...
\boxtext{Informāciju par rīkiem un resursiem, kuru nosaukumi tekstā ir treknrakstā, var skatīt arī ~\ref{fig:lrlttable_de}.~attēlā sadaļas beigās.}
...
\textit{Google} veiksmes stāsts rāda, ka liels pieejamo datu apjoms un efektīvas indeksēšanas metodes var nodrošināt pietiekami labus rezultātus, \mbox{izmantojot} statistisko pieeju.
...
Ja ir ievadīts vaicājums \textit{Parādiet man visu to uzņēmumu sarakstu, kurus pēdējo piecu gadu laikā ir pārņēmuši citi uzņēmumi}, VT sistēmai jāveic sintaktiskā un \textbf{semantiskā analīze}, kā arī jānodrošina indekss, lai \mbox{varētu} ātri izgūt saistītos dokumentus.
...
SMT sistēmu trenēšanai tiek izmantoti ne tikai publiski pieejamie resursi, bet arī vairāku gadu laikā apkopotie iekšējie \mbox{resursi}.
...
Tas savukārt ir saistīts ar informācijas izvilkšanu (II)~--- ārkārtīgi populāru un ietekmīgu jomu 20.~gs. deviņdesmito gadu sākumā, kad notika būtisks pagrieziens \mbox{datorlingvistikas} attīstībā.
...
Kopumā ņemot, teksta ģenerētāji reti tiek izmantoti kā savrupas lietojumprogrammas, bet tiek iekļauti lielākās programmatūras sistēmās, \mbox{piemēram}, klīniskās informācijas sistēmās, kas apkopo, glabā un apstrādā pacientu datus. 
...
2012.~gada februārī CLARIN ieguva Eiropas pētniecības infrastruktūras konsorcija (\textit{European Research Infrastructure Consortium~--ERIC}) juridisko statusu, tādējādi kļūstot par CLARIN ERIC.
...
Plaši lietotus latviešu valodas atbalsta risinājumus \textit{Macintosh} datoriem izstrādājis uzņēmums \textit{Deksoft} \cite{MetaRef1}.
Uzņēmums \textit{Algorego} \cite{Meta44} \mbox{izstrādā} elektronisko dokumentu informācijas apstrādes un strukturēšanas risinājumus.
...
\ref{fig:mt_cluster_de}.--\ref{fig:resources_cluster_de}.~attēlā ietvertie dati liecina, ka ierobežotā VT finansējuma dēļ latviešu valoda ir nodrošināta sliktāk par daudzām citām Eiropas valodām.
...
Language technology as such has never been a priority research field in Latvia.
...
Latvian, though apparently small, is in fact approximately the 150th~most spoken language from about 6,900~languages of the world.
...
\begin{figure*}[htb]
  ...
  \colorrule{grey3}{\textwidth}{1.5pt}
 \refstepcounter{refs_en}\label{fig:tpa}
\end{figure*}
...
%\boxtext{Tools and resources that are boldfaced in the text can also be found in the table at the end of this chapter.}
...
Now the Latvian spelling checker recognizes more than 22 million forms generated from more than 130 thousand lemmas.
Microsoft licensed the Latvian Spelling Checker from Tilde and includes it into the \textit{Microsoft Office} software suite.
...
A convenient tool to assist in writing texts is the Latvian thesaurus created by Tilde.
...
A Grammar checker verifies sentence structure and punctuation.
...
However, rule-based (or linguistic knowledge-driven) systems often analyse the input text and create an intermediary symbolic representation from which the text can be generated into the target language.
...
The company actively participates in EU research and development activities coordinating several large-scale projects: EuroTermBank (eContent), ACCURAT (FP7), LetsMT! (ICT-PSP) and META-NORD (ICT-PSP) and TaaS(FP7). 
...
\phantomsection\bsection[Atsauces~\textemdash~References]{Atsauces --- References}
\bibliographystyle{unsrt}
\bibliography{latvian_references}
  
\cleardoublepage

\phantomsection\bsection[Dalīb\-organizācijas~\textemdash~META-NET Members]{Dalīb\-organizācijas --- META-NET \ \ \ \ \ \ \ Members}
