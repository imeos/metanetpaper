...
%\editors{
%	Hanna Westerlund\\(toimittaja, \textcolor{grey1}{editor})
%}
\editors{
...
erilaisia ja ne riippuvat kyseisen kielen ominaispiirteistä ja
kieliyhteisön koosta.

Euroopan komission rahoittaman META-NET -huippuosaamisen verkoston kartoitustyö %FIXME: Hyphenate huippuosaamisen
kattaa Euroopan 23 virallisen kielen ja lisäksi sen tärkeiden kansallisten ja
...
% --------------------------------------------------------------------------
\bsection*{IN FINNISH --- Table of Contents}
%FIXME: Translate
...
\begin{figure*}[b]
  \colorrule{grey3}{\textwidth}{1.5pt}
  \center
  \vspace{-5mm} \includegraphics[width=\textwidth]{../_media/finnish/text_processing_app_architecture}
...
tuottamista ja tietokantahakuja. Näinkin yksinkertaistettu
kuvaus sovellusarkkitehtuurista jo paljastaa kieliteknologisten sovellusten 
monimutkaisuuden.
...
Suomessa.  \textbf{Alleviivatut} työkalut ja kieliaineistot
...
Puheteknologioita tarvitaan mukaan käyttöliittymiin, kun halutaan keskustella koneen 
...
\item Automaattinen \textbf{puheentunnistus} määrittelee, mitkä
...
\item Dialoginhallinta päättelee, mihin toimenpiteisiin on syytä ryhtyä
	ottaen huomioon käyttäjän antama syöte ja järjestelmän toimintaperiaate.

\item \textbf{Puhesynteesi} muuttaa järjestelmän vastauksen
    ääneksi käyttäjää
    varten.
...
\begin{figure*}[htb]
  ...
  \colorrule{grey3}{\textwidth}{1.5pt}
\end{figure*}
%FIX: In this figure, we corrected the box "post-editing" to "text generation", please make sure we used the correct translation
...
tuolloin 22 virallisen EU-kielen tulokset kielipareittain (Gaelin
kieli ei ollut vertailussa mukana). Tulokset on arvioitu BLEU-pistein,
joissa paremman käännöksen pistemäärä on aina korkeampi
\cite{BLEU}. Ihminen saisi käännöstehtävästä keskimäärin 80 pistettä.
...
\begin{figure*}[tb]
  ...
  & \multicolumn{22}{>{\columncolor{orange1}}c}{Kohdekieli -- Target Language}\\\addlinespace[{-.009cm}]
...
(Nordic Graudate School of Language Technology). KIT-tutkijakoulu sai kahdelle
...
%FIX: Removed the following sentence (doesn't seem to appear in the Finnish version)
...
%FIX: Inserted this sentence: please integrate it into the Finnish version
...
While such applications tend to be very complex, figure~\ref{fig:textprocessingarch_en} shows a highly simplified architecture of a typical text processing system. The first three modules handle the structure and meaning of the text input:
...
look-ups. 
%FIX: Removed the following sentence:
...
%FIX: Replaced paragraph above by:
...
%Tools and resources that are \textbf{bold-faced} in the text can also be found in the summary table.
%FIX: Replaced sentence above
...
%FIX: Replaced sentence above by:
...
interaction %FIX: Inserted "interaction"
...
%The languages were positioned into clusters based on the following five-point scale:
%FIX: Replaced sentence above
...
Yhdistyneet Kuningaskunnat & \textcolor{grey1}{UK} & 
