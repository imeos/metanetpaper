...
\subtitle{White Paper Series --- White Paper Series}
...
kieliteknologiasta ja sen tarjoamista mahdollisuuksista. Tämän julkaisun
tavoitteena on herättää opettajia, toimittajia, poliitikkoja, kieliyhteisöjä ja
...
Euroopan komission rahoittaman META-NET huippuosaamisen verkoston tekemä kartoitus
...
\ParallelLText{\selectlanguage{finnish}
% \boxtext{Olemme todistamassa digitaalista vallankumousta, jolla on dramaattiset vaikutukset viestintään ja yhteiskuntaan.}
Olemme todistamassa digitaalista vallankumousta, jolla on dramaattiset
...
\ParallelLText{\selectlanguage{finnish}
% \boxtext{Maailmanlaajuisten talousmarkkinoiden ja tiedonkulun alueella yhä enemmän kieliä, puhujia ja sisältöä on jatkuvassa vuorovaikutuksessa keskenään.}
...
% \boxtext{Euroopan kielten kirjo on sen tärkeimpiä voimavaroja.} 
...
% \boxtext{Kieliteknologiat auttavat ihmisiä tekemään yhteistyötä, hoitamaan liikeasioita, jakamaan tietoa ja ottamaan osaa monikieliseen sosiaaliseen ja poliittiseen keskusteluun.}
...
% \boxtext{Eurooppa tarvitsee kaikille sen kielille sovitettua vakaata, kohtuuhintaista ja tärkeimpiin ohjelmistoympäristöihin tiiviisti integroitua kieliteknologiaa.}
...
% \boxtext{Kieliteknologia auttaa vastaamaan Euroopan moninaisiin monikielisyyden haasteisiin.}
...
% \boxtext{Kieliteknologisten menetelmien kaksi päätyyppiä oppivat tietoa kielestä samalla tavoin.}
...
% \boxtext{Suomen kielen ominaispiirteitä on rikas taivutusjärjestelmä.}
...
\ParallelLText{\selectlanguage{finnish}
	% \boxtext{Suomen kielen virallinen huolto on lain ja asetuksen mukaan Kotimaisten kielten tutkimuskeskuksen tehtävä.}
Suomen kielen virallinen huolto on lain ja asetuksen mukaan Kotimaisten kielten
...
% \boxtext{Suomi on osallistunut kaikille neljälle PISA-arviointikierrokselle vuosina 2000, 2003, 2006 ja 2009.}
...
\ParallelLText{\selectlanguage{finnish}
% \boxtext{Suomen kieli on 1900-luvun lopulle asti ollut kansainvälisissä yhteyksissä vastaanottava kieli. Maailman kaunokirjallisuus ja tieteen saavutukset on saatu Suomeen käännösten välityksellä.}
...
\ParallelRText{\selectlanguage{english}
% \boxtext{Until the late 20th century Finnish was a receiving language for
...
% the Finns through translations.}	
...
the European Unyion in 1995. For the first time in its history, Finnish
...
\ParallelLText{\selectlanguage{finnish}
% \boxtext{Vuonna 2009 Suomessa oli lähes 1,5 miljoonaa laajkaistaliittymää ja reilusti yli miljoona langatonta yhteyttä.}	
...
\ssubsubsection{Puheteknologia --- Speech Technology}
...
\ParallelRText{\selectlanguage{english}
 % \boxtext{Speech technology is the basis for creating
