...
%
%
%            - META-NET Language Whitepaper | Swedish paper -
...
\hyphenation{språk-tek-no-logi språk-tek-no-login in-forma-tions-sam-hälle in-forma-tions-sam-hället}
\hyphenation{maskin-över-sätt-ning maskin-över-sätt-nings-system doku-ment-pro-duk-tion dok-ment-pro-duk-tion-en}
\hyphenation{vitt-för-grenat reaktor-haveriet på-verka på-verkas upp-skatt-at under-visning under-gång person-datorer fort-farande in-flyt-ande be-segrade}
\hyphenation{science sciences theory processor center}
...
stabil och aktiv, och den årliga bokmässan i Göteborg är störst i sltt %% TODO: fix typo
...
\boxtext{Vi bevittnar just en digital revolution som kan jäm\-föras med Gutenbergs upp\-finning av bok\-tryckar\-konsten.}
...
\boxtext{Vi står inför ett globalt informationssamhälle med olika språk, språk\-brukare och informa\-tions\-inne\-håll.}
...
\boxtext{De tek\-niska fram\-steg\-en går fort\-far\-ande för lång\-samt.}
...
% Mikael Parkvall's Swedish table:
\begin{figure*}[!h]
\centering
...
\boxtext{Verktyg och resurser som återfinns i lägesöversikten i
  tabell~\ref{fig:lrlttable_sv} i
  avsnitt~\ref{section:LTavailability_sv} återges i \textbf{fetstil} i
  texten nedan.}
...
\boxtext{Den enklaste maskinöversättningsmetoden är helt enkelt att
...
%    & \multicolumn{22}{>{\columncolor{corange1}}c}{Målspråk -- \textcolor{grey1}{Target language}}\\\addlinespace[{-.009cm}]
    & \multicolumn{22}{>{\columncolor{corange1}}c}{Målspråk}\\\addlinespace[{-.009cm}]
...
\cellcolor{orange2}{\emph{Uppsala universitet:}} \\
\begin{itemize} \item \vspace{-20pt} Institutionen för lingvistik och filologi \vspace{-20pt} \end{itemize} \\ %\addlinespace \addlinespace \addlinespace
\end{tabular}
\end{minipage}
...
\boxtext{Table~\ref{fig:lrlttable_en} in section~\ref{section:LTavailability_en} shows the state of tools and resources that are \textbf{bold-faced} in the following text.}
...
\boxtext{For Swedish, research in most text technologies is much less developed than for the English language.}
...
\begin{minipage}[t]{\linewidth}
\begin{tabular}{p{0.9\columnwidth}}
\cellcolor{orange1}{\textbf{Speech and dialogue technology}} \\
\cellcolor{orange2}{\emph{KTH, Royal Institute of Technology:}} \\
...
\bsection[Litteratur -- References]{Litteratur --- References}
\bibliographystyle{plain}
\bibliography{references}
  
\cleardoublepage

\bsection[Medlemmar i META-NET -- META-NET Members]{META-NETs medlemmar --- META-NET Members}
...
\bsection[META-NETs vitböcker -- The META-NET White Paper Series]{META-NETs vitböcker --- The META-NET White Papers}% Series}
