...
\boxtext{Šiuo metu technologinė pažanga yra pernelyg lėta.} %%FIX: Adapt to eglish version if you want
...
\begin{figure*}[htb]
  ...
  \caption{Kalbos taisyklingumo tikrinimas (viršuje - pagrįstas taisyklėmis, apačioje - statistiniais metodais)} %%FIX: Is that correct for "top" and "bottom"?
...
\boxtext{Šnekamosios kalbos technologijos taikomos norint sukurti sąsajas, leisiančias naudotojams bendrauti su kompiuteriu balsu, o ne naudojantis ekranu, klaviatūra ir pele.} %%%FIX: Adapt to english version if you want

\begin{figure*}[htb]
  \colorrule{grey3}{\textwidth}{1.5pt}
  \center 
  \includegraphics[width=\textwidth]{../_media/lithuanian/simple_speech-based_dialogue_architecture}
  \caption{Nesudėtingo balsinio dialogo architektūra} %%%FIX: Adapt to english version if you want: Without "Simple"
...
\begin{figure*}[htb]
  ...
  \caption{Automatinis vertimas (kairėje - pagrįstas statistiniais metodais, dešinėje - taisyklėmis)}  %%FIX: Is that correct for "left" and "right"?
  \label{fig:mtarch_de}
  \colorrule{grey3}{\textwidth}{1.5pt}
\end{figure*}
...
\begin{figure*}[htbp]
  ...
  \begin{tabular}{>{\columncolor{corange1}}cccccccccccccccccccccccc}
    & \multicolumn{22}{>{\columncolor{corange1}}c}{Zielsprache -- \textcolor{grey1}{Target language}}\\\addlinespace[{-.009cm}]  %%%FiX "Zielspache" - please translate to lithuanian
