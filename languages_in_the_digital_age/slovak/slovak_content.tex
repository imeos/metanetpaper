...
\begin{figure*}[htbp]
  ...
  \begin{tabular}{>{\columncolor{corange1}}cccccccccccccccccccccccc}
    & \multicolumn{22}{>{\columncolor{corange1}}c}{Cieľový jazyk -- Target language}\\\addlinespace[{-.009cm}]
    ...
    \end{tabular}
  \caption{Strojový preklad medzi 22 jazykmi EU -- Machine Translation between 22 EU-languages\cite{euro1}}
