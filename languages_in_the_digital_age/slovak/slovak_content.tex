...
%
%
%            - META-NET Language Whitepaper | Slovak content -
% 
% ----------------------------------------------------------------------------
...
%FIXME please add page references
...
jazyk veľkomoravského etnika členený na nárečia, ale reprezentovaný aj istou kultúrnou podobou. Najbúrlivejší vývin
...
približne \emph{1\,‰}\footnote{Počet všetkých domén
...
Slovak Online\footnote{\url{http://www.slovake.eu}} je projekt umožňujúci bezplatné štúdium
...
Databáza hovoreného korpusu\footnote{\url{http://www.korpus.sk/shk.html}} obsahuje zvukové záznamy
...
\begin{figure*}[htbp]
  ...
  \begin{tabular}{>{\columncolor{corange1}}cccccccccccccccccccccccc}
    & \multicolumn{22}{>{\columncolor{corange1}}c}{FIXME -- Target language}\\\addlinespace[{-.009cm}]
...
10\,th century. Main changes took place and were stabilised before the
15\,th century; some of them equally (reduction of the nasal
...
(Slovakia became a part of the Kingdom of Hungary in the 11\,th
...
thousand\footnote{\url{https://www.sk-nic.sk/documents/pdf/2010-12-31_SK-NIC_PS.pdf}}.
The amount of \emph{.sk} domains on the worldwide web was about
1‰\footnote{Number of all domains according to
\url{http://www.verisigninc.com} was reaching approximately 200 million
at the end of year 2010.} by the end of 2010. The style of Internet
...
Slovak language presence on the internet\footnote{And generally, in
anything computer related.} was the habit of using the language without
