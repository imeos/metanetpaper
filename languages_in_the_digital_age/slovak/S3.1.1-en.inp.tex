...
\begin{itemize}
\item[a)] Western Slovak dialects
...
\end{enumerate}
\item[b)] Central Slovak dialects
...
\item Gemer dialects
\end{enumerate}
\item[c)] Eastern Slovak dialects

The eastern Slovak dialects can be found in the regions of Spiš, Šariš, Zemplín and Abov.
\begin{enumerate}
\setcounter{enumi}{29}
\item Spiš dialects
\item Abov dialects
