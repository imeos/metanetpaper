...
Digitálne jazykové technológie (v~písanom aj hovorenom diskurze) pomáhajú ľudom spolupracovať, podnikať, sprístupňovať vedomosti a~zúčastňovať sa na sociálnych a~politických diskusiách bez ohľadu na jazykové bariéry alebo počítačové zručnosti. Sú užitočné v~prípade:
...
\item náhľadu odporúčania produktu v~internetovom obchode,
\item počúvania slovných inštrukcií navigačného systému,
\item prekladu webových stránok s~on–line službami.
\end{itemize}
