...
Em Novembro de 2011, a rede META-NET integrava 54 centros de investigação de 33 países europeus (p.~\pageref{metanetmembers}). Esta rede está a colaborar com atores do setor da economia (empresas de software, fornecedores de tecnologia, utilizadores), agências governamentais, instituições de investigação, organizações não governamentais, comunidades linguísticas e universidades. 
...
\begin{enumerate}
  ...
  \item análise gramatical: deteção do verbo e dos seus complementos e modificadores, deteção de elementos de outras categorias, assim como identificação da estrutura das frases; 
...
O verbo \it{googlar} passou a ter uma entrada no dicionário de Português online da Porto Editora \cite{portoeditoraonline}. 
...
de forma mais flexível -- numa interação desencadeada, por exemplo, pela pergunta “\it{Como posso ajudá-lo?}” --, têm por isso uma melhor aceitação. Mas esta alternativa envolve a criação, 
...
In the other Portuguese speaking countries, the language technology area shows little or no development, with the data collection and the development of resources and tools targeted to Portuguese in Africa being undertaken 
