...
Este Livro Branco, sobre a língua portuguesa na era digital, faz parte de uma coleção que promove o conhecimento sobre a tecnologia da linguagem e o seu potencial. 
...
Em Novembro de 2011, a rede META-NET integrava 54 centros de investigação de 33 países europeus (p.~\pageref{metanetmembers}). Esta rede está a colaborar com atores do setor da economia (empresas de software, fornecedores de tecnologia, utilizadores), agências governamentais, ins\-ti\-tui\-ções de investigação, organizações não governamentais, comunidades linguísticas e universidades. 
...
a desenvolverem novas aplicações que permitam a inter-compreensão entre falantes de diferentes idiomas e o acesso a co\-nhe\-ci\-men\-to partilhado. 
...
\begin{itemize}
    \item torne possíveis a comunicação e a cooperação entre as línguas; 
