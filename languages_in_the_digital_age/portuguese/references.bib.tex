...
@Misc{statop20,
  title =	 {{}},
  note =
                  "\url{http://www.internetworldstats.com/top20.htm}"
}

@Misc{stat4,
  title =	 {{}},
  note =
                  "\url{http://www.internetworldstats.com/stats4.htm}"
}

@Misc{stat15,
  title =	 {{}},
  note =
                  "\url{http://www.internetworldstats.com/stats15.htm}"
}

@Misc{mybroadband,
  title =	 {{}},
  note =
                  "\url{http://mybroadband.co.za/news/internet/15031-Internet-access-Brazil-booms.html}"
}
...
@Misc{umic,
  title =	 {{}},
  note =
                  "\url{http://www.umic.pt/index.php?option=com_content&task=view&id=2777&Itemid=40}"
}
