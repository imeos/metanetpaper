...
\boxtext{Språkteknologi bygger broer.}

%start Norwegian, dvs. her er det tilpasninger til den norske situasjonen
...
%end Norwegian, dvs. herfra er det standard tekst, samme tekst som den tyske versjonen
...
\boxtext{Språkteknologi som en nøkkel for fremtiden}
...
\boxtext{Språkteknologi forenkler kommunikasjon i Europa}
...
Norsk er ikke etter loven definert som nasjonalspråk i Norge, og det har blitt sagt ironisk at det finnes lover for å beskytte minoritetsspråk og standardnynorsk, men ingen språkpolitikk for å beskytte norsk bokmål \cite{nih:2005}. 
...
\begin{figure*}[htb]
  ...
  \center
  \includegraphics[width=\textwidth]{../_media/bokmaal/language_technologies}
...
\begin{figure*}[htb]
  \colorrule{grey3}{\textwidth}{1.5pt}
  \center
  \includegraphics[width=\textwidth]{../_media/bokmaal/text_processing_app_architecture}
...
\begin{figure*}[htb]
  \colorrule{grey3}{\textwidth}{1.5pt}
  \center
  \includegraphics[width=\textwidth]{../_media/bokmaal/language_checking}
...
\begin{figure*}[htb]
  \colorrule{grey3}{\textwidth}{1.5pt}
  \center
  \includegraphics[width=\textwidth]{../_media/bokmaal/web_search_architecture}
  \caption{Nettsøk}
...
\begin{figure*}[htb]
  \colorrule{grey3}{\textwidth}{1.5pt}
  \center
  \includegraphics[width=\textwidth]{../_media/bokmaal/simple_speech-based_dialogue_architecture}
...
\begin{figure*}[htb]
  \colorrule{grey3}{\textwidth}{1.5pt}
  \center
  \includegraphics[width=\textwidth]{../_media/bokmaal/machine_translation}
...
Universitetet i Bergen koordinerer CLARA, et nettverk for forskerutdanning ved ni europeiske institusjoner.
