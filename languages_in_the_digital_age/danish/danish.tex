...
%\renewcommand{\bsection}{\begin{minipage}[t]{4mm}\ \end{minipage}}

%\let\Oldbsection\bsection
%\renewcommand{\bsection}{\begin{minipage}[t]{4mm}\ \end{minipage \Oldbsection}}
...
\begin{figure*}[htbp]
  ...
  \begin{tabular}{>{\columncolor{corange1}}cccccccccccccccccccccccc}
    ...
    \end{tabular}
  \caption{Maskinovers\ae ttelse mellem 22 EU-sprog -- \textcolor{grey1}{Machine translation between 22 EU-languages\cite{euro1}}}
