...
Tá 54 ionad taighde as 33 tír i META-NET atá ag oibriú le geallsealbhóirí ó ghnólachtaí tráchtála (lch.~\pageref{metanetmembers}), gníomhaireachtaí rialtais, tionscal, eagraíochtaí taighde, cuideachtaí bogearraí, soláthraithe teicneolaíochta agus ollscoileanna san Eoraip. Le chéile, tá siad ag cruthú comhfhís teicneolaíochta agus ag forbairt clár taighde straitéiseach a léiríonn an chaoi gur féidir le feidhmchláir teicneolaíochta teanga dul i ngleic le bearna i dtaighde faoi 2020.}
...
\boxtext{Tá dul chun cinn na teicneolaíochta\\[.3mm] rómhall faoi láthair.}
...
\boxtext{Níl úsáid na seiceála teanga teoranta do phróiseálaithe focail; baineann sé chomh maith le córais tacaíochta údaraithe.} 
...
\boxtext{Úsáidtear teicneolaíocht idirghníomhaíochta\\ labhartha mar bhunús le comhéadain a chruthú\\[.3mm] a cheadaíonn úsáideoirí le hidirghníomhú\\ le teanga labhartha in áit amharc grafach,\\ méarchlár agus luchóg.}
...
\begin{figure*}[htbp]
  ...
  \begin{tabular}{>{\columncolor{corange1}}cccccccccccccccccccccccc}
    & \multicolumn{22}{>{\columncolor{corange1}}c}{Sprioctheanga -- \textcolor{grey1}{Target language}}\\\addlinespace[{-.009cm}] 
...
\boxtext{Cuireann feidhmchláir teicneolaíochta teanga\\ feidhmeanna seirbhíse suntasacha ar fáil\\[.4mm] “laistigh” de chórais bhogearraí níos mó.}
...
\begin{figure*}[tb]
  ...
  \multicolumn{1}{>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{}} & 
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{}} &
  ...
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{Tacaíocht}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c@{\hspace{.040\linewidth}}}{\textbf{Tacaíocht}} &
  \multicolumn{1}{@{}>{\columncolor{white}}c}{\textbf{lag nó gan}} \\ 
  %
  ...
  \multicolumn{1}{@{}>{\columncolor{white}}c}{\textbf{tacaíocht}} \\ \addlinespace
...
\textbf{\centerline{office@meta-net.eu -- \url{http://www.meta-net.eu}}}
...
\phantomsection
\bsection[Baill de META-NET -- META-NET Members]{Baill de META-NET --- META-NET Members}
