...
\authoraffiliation{
  Diana Trandabăț~~ {\small UAIC, ICS\\}
  Elena~ Irimia~~ {\small RIAI\\}
  Verginica~ Mititelu~~ {\small RIAI\\}
  Dan Cristea~~ {\small UAIC, ICS\\}
  Dan Tufiș~~ {\small RIAI\\}
 ~\\
 \footnotesize{UAIC} ~ \small{University “Alexandru Ioan Cuza” of Iași}\\
 \footnotesize{ICS} ~~~~ \small{Romanian Academy, Inst. of Computer Science}\\
 \footnotesize{RIAI} ~~~ \small{Romanian Academy, Research Inst. for~ AI}
}
\editors{
