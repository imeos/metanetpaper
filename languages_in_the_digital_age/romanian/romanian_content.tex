...
Institutul de Filologie Română „A. Philippide” din Iași a elaborat \textit{Arhiva de Folclor a Moldovei și Bucovinei}, pe baza căreia s-a dezvoltat proiectul \textit{Obiceiurile ciclului familial: nașterea, nunta și înmormântarea}. De asemenea, institutul din Iași a colaborat cu institutele lingvistice din București și Cluj-Napoca la crearea și publicarea \textit{Atlasului lingvistic pe regiuni}, o operă de importanță majoră pentru lingvistica românească.
